...
#ifndef _SAMG55_PIOA_INSTANCE_H_
#define _SAMG55_PIOA_INSTANCE_H_

/* ========== Register definition for PIOA peripheral ========== */
#if (defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))

#define REG_PIOA_PER            (0x400E0E00) /**< (PIOA) Enable Register */
#define REG_PIOA_PDR            (0x400E0E04) /**< (PIOA) Disable Register */
#define REG_PIOA_PSR            (0x400E0E08) /**< (PIOA) Status Register */
...
#define REG_PIOA_DRIVER         (0x400E0F10) /**< (PIOA) I/O Drive Register */

#else

#define REG_PIOA_PER            (*(__O  uint32_t*)0x400E0E00U) /**< (PIOA) Enable Register */
#define REG_PIOA_PDR            (*(__O  uint32_t*)0x400E0E04U) /**< (PIOA) Disable Register */
#define REG_PIOA_PSR            (*(__I  uint32_t*)0x400E0E08U) /**< (PIOA) Status Register */
...
#define REG_PIOA_DRIVER         (*(__IO uint32_t*)0x400E0F10U) /**< (PIOA) I/O Drive Register */

#endif /* (defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */

/* ========== Instance Parameter definitions for PIOA peripheral ========== */
#define PIOA_INSTANCE_ID                         11
