...
/******  SAMG55J19 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMG55J19 Embedded Flash Controller (EFC) */
  FLEXCOM7_IRQn             = 7  , /**< 7   SAMG55J19 Flexible Serial Communication (FLEXCOM7) */
  FLEXCOM0_IRQn             = 8  , /**< 8   SAMG55J19 Flexible Serial Communication (FLEXCOM0) */
  FLEXCOM1_IRQn             = 9  , /**< 9   SAMG55J19 Flexible Serial Communication (FLEXCOM1) */
  PIOA_IRQn                 = 11 , /**< 11  SAMG55J19 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 12 , /**< 12  SAMG55J19 Parallel Input/Output Controller (PIOB) */
  PDMIC0_IRQn               = 13 , /**< 13  SAMG55J19 Pulse Density Modulation Interface Controller (PDMIC0) */
  FLEXCOM2_IRQn             = 14 , /**< 14  SAMG55J19 Flexible Serial Communication (FLEXCOM2) */
  MEM2MEM_IRQn              = 15 , /**< 15  SAMG55J19 Memory to Memory (MEM2MEM) */
  I2SC0_IRQn                = 16 , /**< 16  SAMG55J19 Inter-IC Sound Controller (I2SC0) */
  I2SC1_IRQn                = 17 , /**< 17  SAMG55J19 Inter-IC Sound Controller (I2SC1) */
  PDMIC1_IRQn               = 18 , /**< 18  SAMG55J19 Pulse Density Modulation Interface Controller (PDMIC1) */
  FLEXCOM3_IRQn             = 19 , /**< 19  SAMG55J19 Flexible Serial Communication (FLEXCOM3) */
  FLEXCOM4_IRQn             = 20 , /**< 20  SAMG55J19 Flexible Serial Communication (FLEXCOM4) */
  FLEXCOM5_IRQn             = 21 , /**< 21  SAMG55J19 Flexible Serial Communication (FLEXCOM5) */
  FLEXCOM6_IRQn             = 22 , /**< 22  SAMG55J19 Flexible Serial Communication (FLEXCOM6) */
  TC0_IRQn                  = 23 , /**< 23  SAMG55J19 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMG55J19 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMG55J19 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMG55J19 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMG55J19 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMG55J19 Timer Counter (TC1)       */
  ADC_IRQn                  = 29 , /**< 29  SAMG55J19 Analog-to-Digital Converter (ADC) */
  UHP_IRQn                  = 47 , /**< 47  SAMG55J19 USB Host Port (UHP)       */
  UDP_IRQn                  = 48 , /**< 48  SAMG55J19 USB Device Port (UDP)     */
  CRCCU_IRQn                = 49 , /**< 49  SAMG55J19 Cyclic Redundancy Check Calculation Unit (CRCCU) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMG55J19 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMG55J19 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMG55J19 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMG55J19 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMG55J19 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMG55J19 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMG55J19 Embedded Flash Controller (EFC) */
  void* pfnFLEXCOM7_Handler;                     /* 7   SAMG55J19 Flexible Serial Communication (FLEXCOM7) */
  void* pfnFLEXCOM0_Handler;                     /* 8   SAMG55J19 Flexible Serial Communication (FLEXCOM0) */
  void* pfnFLEXCOM1_Handler;                     /* 9   SAMG55J19 Flexible Serial Communication (FLEXCOM1) */
  void* pvReserved10;
  void* pfnPIOA_Handler;                         /* 11  SAMG55J19 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 12  SAMG55J19 Parallel Input/Output Controller (PIOB) */
  void* pfnPDMIC0_Handler;                       /* 13  SAMG55J19 Pulse Density Modulation Interface Controller (PDMIC0) */
  void* pfnFLEXCOM2_Handler;                     /* 14  SAMG55J19 Flexible Serial Communication (FLEXCOM2) */
  void* pfnMEM2MEM_Handler;                      /* 15  SAMG55J19 Memory to Memory (MEM2MEM) */
  void* pfnI2SC0_Handler;                        /* 16  SAMG55J19 Inter-IC Sound Controller (I2SC0) */
  void* pfnI2SC1_Handler;                        /* 17  SAMG55J19 Inter-IC Sound Controller (I2SC1) */
  void* pfnPDMIC1_Handler;                       /* 18  SAMG55J19 Pulse Density Modulation Interface Controller (PDMIC1) */
  void* pfnFLEXCOM3_Handler;                     /* 19  SAMG55J19 Flexible Serial Communication (FLEXCOM3) */
  void* pfnFLEXCOM4_Handler;                     /* 20  SAMG55J19 Flexible Serial Communication (FLEXCOM4) */
  void* pfnFLEXCOM5_Handler;                     /* 21  SAMG55J19 Flexible Serial Communication (FLEXCOM5) */
  void* pfnFLEXCOM6_Handler;                     /* 22  SAMG55J19 Flexible Serial Communication (FLEXCOM6) */
  void* pfnTC0_Handler;                          /* 23  SAMG55J19 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMG55J19 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMG55J19 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMG55J19 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMG55J19 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMG55J19 Timer Counter (TC1)  */
  void* pfnADC_Handler;                          /* 29  SAMG55J19 Analog-to-Digital Converter (ADC) */
  void* pvReserved30;
  void* pvReserved31;
  void* pvReserved32;
  void* pvReserved33;
  ...
  void* pvReserved45;
  void* pvReserved46;
  void* pfnUHP_Handler;                          /* 47  SAMG55J19 USB Host Port (UHP)  */
  void* pfnUDP_Handler;                          /* 48  SAMG55J19 USB Device Port (UDP) */
  void* pfnCRCCU_Handler;                        /* 49  SAMG55J19 Cyclic Redundancy Check Calculation Unit (CRCCU) */
} DeviceVectors;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
...
/** \defgroup SAMG55J19_reg Registers Access Definitions
 *  @{
 */
...
#define SPI7                   (0x40034400)                   /**< \brief (SPI7      ) Base Address */
...
#define TWI7                   (0x40034600)                   /**< \brief (TWI7      ) Base Address */
...
#define USART7                 (0x40034200)                   /**< \brief (USART7    ) Base Address */
...
#define SPI_INST_NUM           8                              /**< \brief (SPI       ) Number of instances */
#define SPI_INSTS              { SPI0, SPI1, SPI2, SPI3, SPI4, SPI5, SPI6, SPI7 } /**< \brief (SPI       ) Instances List */
...
#define TWI_INST_NUM           8                              /**< \brief (TWI       ) Number of instances */
#define TWI_INSTS              { TWI0, TWI1, TWI2, TWI3, TWI4, TWI5, TWI6, TWI7 } /**< \brief (TWI       ) Instances List */
...
#define USART_INST_NUM         8                              /**< \brief (USART     ) Number of instances */
#define USART_INSTS            { USART0, USART1, USART2, USART3, USART4, USART5, USART6, USART7 } /**< \brief (USART     ) Instances List */
