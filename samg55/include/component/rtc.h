...
#define _SAMG55_RTC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG55 Real-time Clock
 *  @{
 */
/* ========================================================================== */
...
#define REV_RTC T                      /**< (RTC) Module revision */
...
typedef union {
  struct {
    ...
    uint32_t OUT0:3;                    /**< bit: 16..18  All ADC Channel Trigger Event Source Selection */
    uint32_t :1;                        /**< bit:     19  Reserved */
    uint32_t OUT1:3;                    /**< bit: 20..22  ADC Last Channel Trigger Event Source Selection */
...
#define RTC_MR_OUT0_Pos                     16                                             /**< (RTC_MR) All ADC Channel Trigger Event Source Selection Position */
...
#define RTC_MR_OUT1_Pos                     20                                             /**< (RTC_MR) ADC Last Channel Trigger Event Source Selection Position */
...
#define RTC_MR_MASK                         _U_(0x77FF13)                                  /**< \deprecated (RTC_MR) Register MASK  (Use RTC_MR_Msk instead)  */
#define RTC_MR_Msk                          _U_(0x77FF13)                                  /**< (RTC_MR) Register Mask  */
...
typedef union {
  struct {
    uint32_t MS:10;                     /**< bit:   0..9  Number of 1/1024 seconds elapsed within 1 second */
...
#define RTC_MSR_OFFSET                      (0xD0)                                        /**<  (RTC_MSR) Milliseconds Register  Offset */

#define RTC_MSR_MS_Pos                      0                                              /**< (RTC_MSR) Number of 1/1024 seconds elapsed within 1 second Position */
...
#define RTC_MSR_MASK                        _U_(0x3FF)                                     /**< \deprecated (RTC_MSR) Register MASK  (Use RTC_MSR_Msk instead)  */
#define RTC_MSR_Msk                         _U_(0x3FF)                                     /**< (RTC_MSR) Register Mask  */
...
typedef struct {
  ...
  RoReg8  Reserved1[0xA0];
  __I  uint32_t RTC_MSR;        /**< (RTC Offset: 0xD0) Milliseconds Register */
...
typedef struct {
  ...
  __I  RTC_MSR_Type                   RTC_MSR;        /**< Offset: 0xD0 (R/   32) Milliseconds Register */
