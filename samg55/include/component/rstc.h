...
#define _SAMG55_RSTC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG55 Reset Controller
 *  @{
 */
/* ========================================================================== */
...
#define REV_RSTC I                      /**< (RSTC) Module revision */
...
typedef union {
  struct {
    ...
    uint32_t PERRST:1;                  /**< bit:      2  Peripheral Reset                         */
...
#define RSTC_CR_PERRST_Pos                  2                                              /**< (RSTC_CR) Peripheral Reset Position */
#define RSTC_CR_PERRST_Msk                  (_U_(0x1) << RSTC_CR_PERRST_Pos)               /**< (RSTC_CR) Peripheral Reset Mask */
#define RSTC_CR_PERRST                      RSTC_CR_PERRST_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use RSTC_CR_PERRST_Msk instead */
...
#define RSTC_CR_MASK                        _U_(0xFF00000D)                                /**< \deprecated (RSTC_CR) Register MASK  (Use RSTC_CR_Msk instead)  */
...
typedef union {
  struct {
    ...
    uint32_t SCKSW:1;                   /**< bit:      1  Slow Clock Switching                     */
...
#define RSTC_MR_SCKSW_Pos                   1                                              /**< (RSTC_MR) Slow Clock Switching Position */
#define RSTC_MR_SCKSW_Msk                   (_U_(0x1) << RSTC_MR_SCKSW_Pos)                /**< (RSTC_MR) Slow Clock Switching Mask */
#define RSTC_MR_SCKSW                       RSTC_MR_SCKSW_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RSTC_MR_SCKSW_Msk instead */
...
#define RSTC_MR_MASK                        _U_(0xFF000F13)                                /**< \deprecated (RSTC_MR) Register MASK  (Use RSTC_MR_Msk instead)  */
