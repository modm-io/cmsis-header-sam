...
#ifndef _SAMS70_MATRIX_COMPONENT_H_
#define _SAMS70_MATRIX_COMPONENT_H_
#define _SAMS70_MATRIX_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMS_SAMS70 AHB Bus Matrix
 *  @{
 */
/* ========================================================================== */
...
#define MATRIX_PRBS_MASK                    _U_(0x03)                                      /**< \deprecated (MATRIX_PRBS) Register MASK  (Use MATRIX_PRBS_Msk instead)  */
#define MATRIX_PRBS_Msk                     _U_(0x03)                                      /**< (MATRIX_PRBS) Register Mask  */
...
typedef union {
  ...
  struct {
    uint32_t RCB:8;                     /**< bit:   0..7  Remap Command Bit for Master 8           */
...
#define MATRIX_MRCR_MASK                    _U_(0x17F)                                     /**< \deprecated (MATRIX_MRCR) Register MASK  (Use MATRIX_MRCR_Msk instead)  */
#define MATRIX_MRCR_Msk                     _U_(0x17F)                                     /**< (MATRIX_MRCR) Register Mask  */

#define MATRIX_MRCR_RCB_Pos                 0                                              /**< (MATRIX_MRCR Position) Remap Command Bit for Master 8 */
#define MATRIX_MRCR_RCB_Msk                 (_U_(0xFF) << MATRIX_MRCR_RCB_Pos)             /**< (MATRIX_MRCR Mask) RCB */
...
typedef union {
  ...
  struct {
    uint32_t :4;                        /**< bit:   0..3  Reserved */
    uint32_t SYSIO:5;                   /**< bit:   4..8  PBx2 or ERASE Assignment                 */
    uint32_t :23;                       /**< bit:  9..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} CCFG_SYSIO_Type;
...
#define CCFG_SYSIO_MASK                     _U_(0x10F0)                                    /**< \deprecated (CCFG_SYSIO) Register MASK  (Use CCFG_SYSIO_Msk instead)  */
#define CCFG_SYSIO_Msk                      _U_(0x10F0)                                    /**< (CCFG_SYSIO) Register Mask  */
...
typedef struct {
  __IO uint32_t MATRIX_MCFG[9]; /**< (MATRIX Offset: 0x00) Master Configuration Register 0 */
...
/** \brief MATRIX hardware registers */
typedef struct {
  __IO MATRIX_MCFG_Type               MATRIX_MCFG[9]; /**< Offset: 0x00 (R/W  32) Master Configuration Register 0 */
  __I  uint8_t                        Reserved1[28];
...
#endif /* _SAMS70_MATRIX_COMPONENT_H_ */
