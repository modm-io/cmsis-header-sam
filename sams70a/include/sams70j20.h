 ...
 * \file
 *
 * \brief Header file for ATSAMS70J20
 *
...
#ifndef _SAMS70J20_H_
#define _SAMS70J20_H_
...
/******  SAMS70J20 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMS70J20 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAMS70J20 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAMS70J20 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAMS70J20 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAMS70J20 Parallel Input/Output Controller (PIOB) */
  USART0_IRQn               = 13 , /**< 13  SAMS70J20 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAMS70J20 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  PIOD_IRQn                 = 16 , /**< 16  SAMS70J20 Parallel Input/Output Controller (PIOD) */
  TWIHS0_IRQn               = 19 , /**< 19  SAMS70J20 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAMS70J20 Two-wire Interface High Speed (TWIHS1) */
  SSC_IRQn                  = 22 , /**< 22  SAMS70J20 Synchronous Serial Controller (SSC) */
  TC0_IRQn                  = 23 , /**< 23  SAMS70J20 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMS70J20 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMS70J20 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMS70J20 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMS70J20 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMS70J20 Timer Counter (TC1)       */
  AFEC0_IRQn                = 29 , /**< 29  SAMS70J20 Analog Front-End Controller (AFEC0) */
  DACC_IRQn                 = 30 , /**< 30  SAMS70J20 Digital-to-Analog Converter Controller (DACC) */
  PWM0_IRQn                 = 31 , /**< 31  SAMS70J20 Pulse Width Modulation Controller (PWM0) */
  ICM_IRQn                  = 32 , /**< 32  SAMS70J20 Integrity Check Monitor (ICM) */
  ACC_IRQn                  = 33 , /**< 33  SAMS70J20 Analog Comparator Controller (ACC) */
  USBHS_IRQn                = 34 , /**< 34  SAMS70J20 USB High-Speed Interface (USBHS) */
  AFEC1_IRQn                = 40 , /**< 40  SAMS70J20 Analog Front-End Controller (AFEC1) */
  QSPI_IRQn                 = 43 , /**< 43  SAMS70J20 Quad Serial Peripheral Interface (QSPI) */
  UART2_IRQn                = 44 , /**< 44  SAMS70J20 Universal Asynchronous Receiver Transmitter (UART2) */
  TC6_IRQn                  = 47 , /**< 47  SAMS70J20 Timer Counter (TC2)       */
  TC7_IRQn                  = 48 , /**< 48  SAMS70J20 Timer Counter (TC2)       */
  TC8_IRQn                  = 49 , /**< 49  SAMS70J20 Timer Counter (TC2)       */
  TC9_IRQn                  = 50 , /**< 50  SAMS70J20 Timer Counter (TC3)       */
  TC10_IRQn                 = 51 , /**< 51  SAMS70J20 Timer Counter (TC3)       */
  TC11_IRQn                 = 52 , /**< 52  SAMS70J20 Timer Counter (TC3)       */
  AES_IRQn                  = 56 , /**< 56  SAMS70J20 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAMS70J20 True Random Number Generator (TRNG) */
  XDMAC_IRQn                = 58 , /**< 58  SAMS70J20 Extensible DMA Controller (XDMAC) */
  ISI_IRQn                  = 59 , /**< 59  SAMS70J20 Image Sensor Interface (ISI) */
  PWM1_IRQn                 = 60 , /**< 60  SAMS70J20 Pulse Width Modulation Controller (PWM1) */
  FPU_IRQn                  = 61 , /**< 61  SAMS70J20 Floating Point Unit (FPU) */
  RSWDT_IRQn                = 63 , /**< 63  SAMS70J20 Reinforced Safety Watchdog Timer (RSWDT) */
  IXC_IRQn                  = 68 , /**< 68  SAMS70J20 Floating Point Unit (FPU) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMS70J20 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMS70J20 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMS70J20 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMS70J20 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMS70J20 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMS70J20 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMS70J20 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAMS70J20 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAMS70J20 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAMS70J20 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAMS70J20 Parallel Input/Output Controller (PIOB) */
  void* pvReserved12;
  void* pfnUSART0_Handler;                       /* 13  SAMS70J20 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAMS70J20 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pvReserved15;
  void* pfnPIOD_Handler;                         /* 16  SAMS70J20 Parallel Input/Output Controller (PIOD) */
  void* pvReserved17;
  void* pvReserved18;
  void* pfnTWIHS0_Handler;                       /* 19  SAMS70J20 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAMS70J20 Two-wire Interface High Speed (TWIHS1) */
  void* pvReserved21;
  void* pfnSSC_Handler;                          /* 22  SAMS70J20 Synchronous Serial Controller (SSC) */
  void* pfnTC0_Handler;                          /* 23  SAMS70J20 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMS70J20 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMS70J20 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMS70J20 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMS70J20 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMS70J20 Timer Counter (TC1)  */
  void* pfnAFEC0_Handler;                        /* 29  SAMS70J20 Analog Front-End Controller (AFEC0) */
  void* pfnDACC_Handler;                         /* 30  SAMS70J20 Digital-to-Analog Converter Controller (DACC) */
  void* pfnPWM0_Handler;                         /* 31  SAMS70J20 Pulse Width Modulation Controller (PWM0) */
  void* pfnICM_Handler;                          /* 32  SAMS70J20 Integrity Check Monitor (ICM) */
  void* pfnACC_Handler;                          /* 33  SAMS70J20 Analog Comparator Controller (ACC) */
  void* pfnUSBHS_Handler;                        /* 34  SAMS70J20 USB High-Speed Interface (USBHS) */
  void* pvReserved35;
  void* pvReserved36;
  void* pvReserved37;
  void* pvReserved38;
  void* pvReserved39;
  void* pfnAFEC1_Handler;                        /* 40  SAMS70J20 Analog Front-End Controller (AFEC1) */
  void* pvReserved41;
  void* pvReserved42;
  void* pfnQSPI_Handler;                         /* 43  SAMS70J20 Quad Serial Peripheral Interface (QSPI) */
  void* pfnUART2_Handler;                        /* 44  SAMS70J20 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pvReserved45;
  void* pvReserved46;
  void* pfnTC6_Handler;                          /* 47  SAMS70J20 Timer Counter (TC2)  */
  void* pfnTC7_Handler;                          /* 48  SAMS70J20 Timer Counter (TC2)  */
  void* pfnTC8_Handler;                          /* 49  SAMS70J20 Timer Counter (TC2)  */
  void* pfnTC9_Handler;                          /* 50  SAMS70J20 Timer Counter (TC3)  */
  void* pfnTC10_Handler;                         /* 51  SAMS70J20 Timer Counter (TC3)  */
  void* pfnTC11_Handler;                         /* 52  SAMS70J20 Timer Counter (TC3)  */
  void* pvReserved53;
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAMS70J20 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAMS70J20 True Random Number Generator (TRNG) */
  void* pfnXDMAC_Handler;                        /* 58  SAMS70J20 Extensible DMA Controller (XDMAC) */
  void* pfnISI_Handler;                          /* 59  SAMS70J20 Image Sensor Interface (ISI) */
  void* pfnPWM1_Handler;                         /* 60  SAMS70J20 Pulse Width Modulation Controller (PWM1) */
  void* pfnFPU_Handler;                          /* 61  SAMS70J20 Floating Point Unit (FPU) */
  void* pvReserved62;
  void* pfnRSWDT_Handler;                        /* 63  SAMS70J20 Reinforced Safety Watchdog Timer (RSWDT) */
  void* pvReserved64;
  void* pvReserved65;
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70J20 Floating Point Unit (FPU) */
} DeviceVectors;
...
/** @}  end of SAMS70J20_cmsis CMSIS Definitions */

/** \defgroup SAMS70J20_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMS70J20_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAMS70J20_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAMS70J20 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMS70J20 */
/* ************************************************************************** */
