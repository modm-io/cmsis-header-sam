 ...
 * \file
 *
 * \brief Header file for ATSAMS70N21
 *
...
#ifndef _SAMS70N21_H_
#define _SAMS70N21_H_
...
/******  SAMS70N21 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMS70N21 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAMS70N21 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAMS70N21 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAMS70N21 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAMS70N21 Parallel Input/Output Controller (PIOB) */
  USART0_IRQn               = 13 , /**< 13  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  USART2_IRQn               = 15 , /**< 15  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  PIOD_IRQn                 = 16 , /**< 16  SAMS70N21 Parallel Input/Output Controller (PIOD) */
  HSMCI_IRQn                = 18 , /**< 18  SAMS70N21 High Speed MultiMedia Card Interface (HSMCI) */
  TWIHS0_IRQn               = 19 , /**< 19  SAMS70N21 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAMS70N21 Two-wire Interface High Speed (TWIHS1) */
  SPI0_IRQn                 = 21 , /**< 21  SAMS70N21 Serial Peripheral Interface (SPI0) */
  SSC_IRQn                  = 22 , /**< 22  SAMS70N21 Synchronous Serial Controller (SSC) */
  TC0_IRQn                  = 23 , /**< 23  SAMS70N21 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMS70N21 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMS70N21 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMS70N21 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMS70N21 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMS70N21 Timer Counter (TC1)       */
  AFEC0_IRQn                = 29 , /**< 29  SAMS70N21 Analog Front-End Controller (AFEC0) */
  DACC_IRQn                 = 30 , /**< 30  SAMS70N21 Digital-to-Analog Converter Controller (DACC) */
  PWM0_IRQn                 = 31 , /**< 31  SAMS70N21 Pulse Width Modulation Controller (PWM0) */
  ICM_IRQn                  = 32 , /**< 32  SAMS70N21 Integrity Check Monitor (ICM) */
  ACC_IRQn                  = 33 , /**< 33  SAMS70N21 Analog Comparator Controller (ACC) */
  USBHS_IRQn                = 34 , /**< 34  SAMS70N21 USB High-Speed Interface (USBHS) */
  AFEC1_IRQn                = 40 , /**< 40  SAMS70N21 Analog Front-End Controller (AFEC1) */
  TWIHS2_IRQn               = 41 , /**< 41  SAMS70N21 Two-wire Interface High Speed (TWIHS2) */
  QSPI_IRQn                 = 43 , /**< 43  SAMS70N21 Quad Serial Peripheral Interface (QSPI) */
  UART2_IRQn                = 44 , /**< 44  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART2) */
  UART3_IRQn                = 45 , /**< 45  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART3) */
  UART4_IRQn                = 46 , /**< 46  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART4) */
  TC6_IRQn                  = 47 , /**< 47  SAMS70N21 Timer Counter (TC2)       */
  TC7_IRQn                  = 48 , /**< 48  SAMS70N21 Timer Counter (TC2)       */
  TC8_IRQn                  = 49 , /**< 49  SAMS70N21 Timer Counter (TC2)       */
  TC9_IRQn                  = 50 , /**< 50  SAMS70N21 Timer Counter (TC3)       */
  TC10_IRQn                 = 51 , /**< 51  SAMS70N21 Timer Counter (TC3)       */
  TC11_IRQn                 = 52 , /**< 52  SAMS70N21 Timer Counter (TC3)       */
  AES_IRQn                  = 56 , /**< 56  SAMS70N21 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAMS70N21 True Random Number Generator (TRNG) */
  XDMAC_IRQn                = 58 , /**< 58  SAMS70N21 Extensible DMA Controller (XDMAC) */
  ISI_IRQn                  = 59 , /**< 59  SAMS70N21 Image Sensor Interface (ISI) */
  PWM1_IRQn                 = 60 , /**< 60  SAMS70N21 Pulse Width Modulation Controller (PWM1) */
  FPU_IRQn                  = 61 , /**< 61  SAMS70N21 Floating Point Unit (FPU) */
  RSWDT_IRQn                = 63 , /**< 63  SAMS70N21 Reinforced Safety Watchdog Timer (RSWDT) */
  IXC_IRQn                  = 68 , /**< 68  SAMS70N21 Floating Point Unit (FPU) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMS70N21 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMS70N21 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMS70N21 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMS70N21 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMS70N21 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMS70N21 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMS70N21 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAMS70N21 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAMS70N21 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAMS70N21 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAMS70N21 Parallel Input/Output Controller (PIOB) */
  void* pvReserved12;
  void* pfnUSART0_Handler;                       /* 13  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pfnUSART2_Handler;                       /* 15  SAMS70N21 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  void* pfnPIOD_Handler;                         /* 16  SAMS70N21 Parallel Input/Output Controller (PIOD) */
  void* pvReserved17;
  void* pfnHSMCI_Handler;                        /* 18  SAMS70N21 High Speed MultiMedia Card Interface (HSMCI) */
  void* pfnTWIHS0_Handler;                       /* 19  SAMS70N21 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAMS70N21 Two-wire Interface High Speed (TWIHS1) */
  void* pfnSPI0_Handler;                         /* 21  SAMS70N21 Serial Peripheral Interface (SPI0) */
  void* pfnSSC_Handler;                          /* 22  SAMS70N21 Synchronous Serial Controller (SSC) */
  void* pfnTC0_Handler;                          /* 23  SAMS70N21 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMS70N21 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMS70N21 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMS70N21 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMS70N21 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMS70N21 Timer Counter (TC1)  */
  void* pfnAFEC0_Handler;                        /* 29  SAMS70N21 Analog Front-End Controller (AFEC0) */
  void* pfnDACC_Handler;                         /* 30  SAMS70N21 Digital-to-Analog Converter Controller (DACC) */
  void* pfnPWM0_Handler;                         /* 31  SAMS70N21 Pulse Width Modulation Controller (PWM0) */
  void* pfnICM_Handler;                          /* 32  SAMS70N21 Integrity Check Monitor (ICM) */
  void* pfnACC_Handler;                          /* 33  SAMS70N21 Analog Comparator Controller (ACC) */
  void* pfnUSBHS_Handler;                        /* 34  SAMS70N21 USB High-Speed Interface (USBHS) */
  void* pvReserved35;
  void* pvReserved36;
  void* pvReserved37;
  void* pvReserved38;
  void* pvReserved39;
  void* pfnAFEC1_Handler;                        /* 40  SAMS70N21 Analog Front-End Controller (AFEC1) */
  void* pfnTWIHS2_Handler;                       /* 41  SAMS70N21 Two-wire Interface High Speed (TWIHS2) */
  void* pvReserved42;
  void* pfnQSPI_Handler;                         /* 43  SAMS70N21 Quad Serial Peripheral Interface (QSPI) */
  void* pfnUART2_Handler;                        /* 44  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pfnUART3_Handler;                        /* 45  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART3) */
  void* pfnUART4_Handler;                        /* 46  SAMS70N21 Universal Asynchronous Receiver Transmitter (UART4) */
  void* pfnTC6_Handler;                          /* 47  SAMS70N21 Timer Counter (TC2)  */
  void* pfnTC7_Handler;                          /* 48  SAMS70N21 Timer Counter (TC2)  */
  void* pfnTC8_Handler;                          /* 49  SAMS70N21 Timer Counter (TC2)  */
  void* pfnTC9_Handler;                          /* 50  SAMS70N21 Timer Counter (TC3)  */
  void* pfnTC10_Handler;                         /* 51  SAMS70N21 Timer Counter (TC3)  */
  void* pfnTC11_Handler;                         /* 52  SAMS70N21 Timer Counter (TC3)  */
  void* pvReserved53;
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAMS70N21 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAMS70N21 True Random Number Generator (TRNG) */
  void* pfnXDMAC_Handler;                        /* 58  SAMS70N21 Extensible DMA Controller (XDMAC) */
  void* pfnISI_Handler;                          /* 59  SAMS70N21 Image Sensor Interface (ISI) */
  void* pfnPWM1_Handler;                         /* 60  SAMS70N21 Pulse Width Modulation Controller (PWM1) */
  void* pfnFPU_Handler;                          /* 61  SAMS70N21 Floating Point Unit (FPU) */
  void* pvReserved62;
  void* pfnRSWDT_Handler;                        /* 63  SAMS70N21 Reinforced Safety Watchdog Timer (RSWDT) */
  void* pvReserved64;
  void* pvReserved65;
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMS70N21 Floating Point Unit (FPU) */
} DeviceVectors;
...
/** @}  end of SAMS70N21_cmsis CMSIS Definitions */

/** \defgroup SAMS70N21_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMS70N21_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAMS70N21_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAMS70N21 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMS70N21 */
/* ************************************************************************** */
