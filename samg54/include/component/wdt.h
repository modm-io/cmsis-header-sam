...
#ifndef _SAMG54_WDT_COMPONENT_H_
#define _SAMG54_WDT_COMPONENT_H_
#define _SAMG54_WDT_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG54 Watchdog Timer
 *  @{
 */
/* ========================================================================== */
...
#define REV_WDT H                      /**< (WDT) Module revision */
...
typedef union {
  struct {
    ...
    uint32_t WDRPROC:1;                 /**< bit:     14  Watchdog Reset Processor                 */
...
#define WDT_MR_WDRPROC_Pos                  14                                             /**< (WDT_MR) Watchdog Reset Processor Position */
#define WDT_MR_WDRPROC_Msk                  (_U_(0x1) << WDT_MR_WDRPROC_Pos)               /**< (WDT_MR) Watchdog Reset Processor Mask */
#define WDT_MR_WDRPROC                      WDT_MR_WDRPROC_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use WDT_MR_WDRPROC_Msk instead */
...
#define WDT_MR_MASK                         _U_(0x3FFFFFFF)                                /**< \deprecated (WDT_MR) Register MASK  (Use WDT_MR_Msk instead)  */
...
typedef union {
  struct {
    ...
    uint32_t WDERR:1;                   /**< bit:      1  Watchdog Error                           */
...
#define WDT_SR_WDUNF_Pos                    0                                              /**< (WDT_SR) Watchdog Underflow Position */
...
#define WDT_SR_WDERR_Pos                    1                                              /**< (WDT_SR) Watchdog Error Position */
...
#endif /* _SAMG54_WDT_COMPONENT_H_ */
