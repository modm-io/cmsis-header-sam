...
#ifndef _SAMG54_CHIPID_COMPONENT_H_
#define _SAMG54_CHIPID_COMPONENT_H_
#define _SAMG54_CHIPID_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG54 Chip Identifier
 *  @{
 */
/* ========================================================================== */
...
#define   CHIPID_CIDR_ARCH_SAMG54_Val       _U_(0x47)                                      /**< (CHIPID_CIDR) SAM G54  */
#define CHIPID_CIDR_ARCH_SAMG54             (CHIPID_CIDR_ARCH_SAMG54_Val << CHIPID_CIDR_ARCH_Pos)  /**< (CHIPID_CIDR) SAM G54 Position  */
...
#endif /* _SAMG54_CHIPID_COMPONENT_H_ */
