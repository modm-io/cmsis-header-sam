...
#ifndef _SAMG54_SUPC_COMPONENT_H_
#define _SAMG54_SUPC_COMPONENT_H_
#define _SAMG54_SUPC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG54 Supply Controller
 *  @{
 */
/* ========================================================================== */
...
typedef union {
  struct {
    ...
    uint32_t VDDSEL:1;                  /**< bit:      8  VRVDD Field Selection                    */
    uint32_t VRVDD:3;                   /**< bit:  9..11  VRVDD Field Selection                    */
...
#define SUPC_MR_VDDSEL_Pos                  8                                              /**< (SUPC_MR) VRVDD Field Selection Position */
#define SUPC_MR_VDDSEL_Msk                  (_U_(0x1) << SUPC_MR_VDDSEL_Pos)               /**< (SUPC_MR) VRVDD Field Selection Mask */
#define SUPC_MR_VDDSEL                      SUPC_MR_VDDSEL_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use SUPC_MR_VDDSEL_Msk instead */
#define   SUPC_MR_VDDSEL_FACTORY_Val        _U_(0x0)                                       /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VDDSEL_USER_VRVDD_Val     _U_(0x1)                                       /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
#define SUPC_MR_VDDSEL_FACTORY              (SUPC_MR_VDDSEL_FACTORY_Val << SUPC_MR_VDDSEL_Pos)  /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value. Position  */
#define SUPC_MR_VDDSEL_USER_VRVDD           (SUPC_MR_VDDSEL_USER_VRVDD_Val << SUPC_MR_VDDSEL_Pos)  /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD. Position  */
#define SUPC_MR_VRVDD_Pos                   9                                              /**< (SUPC_MR) VRVDD Field Selection Position */
#define SUPC_MR_VRVDD_Msk                   (_U_(0x7) << SUPC_MR_VRVDD_Pos)                /**< (SUPC_MR) VRVDD Field Selection Mask */
#define SUPC_MR_VRVDD(value)                (SUPC_MR_VRVDD_Msk & ((value) << SUPC_MR_VRVDD_Pos))
#define   SUPC_MR_VRVDD_FACTORY_Val         _U_(0x0)                                       /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VRVDD_USER_VRVDD_Val      _U_(0x1)                                       /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
#define SUPC_MR_VRVDD_FACTORY               (SUPC_MR_VRVDD_FACTORY_Val << SUPC_MR_VRVDD_Pos)  /**< (SUPC_MR) The voltage regulator output value is the factory-programmed value. Position  */
#define SUPC_MR_VRVDD_USER_VRVDD            (SUPC_MR_VRVDD_USER_VRVDD_Val << SUPC_MR_VRVDD_Pos)  /**< (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD. Position  */
...
#define SUPC_MR_MASK                        _U_(0xFFD03F00)                                /**< \deprecated (SUPC_MR) Register MASK  (Use SUPC_MR_Msk instead)  */
#define SUPC_MR_Msk                         _U_(0xFFD03F00)                                /**< (SUPC_MR) Register Mask  */
...
#endif /* _SAMG54_SUPC_COMPONENT_H_ */
