...
#ifndef _SAMG54_PDMIC0_INSTANCE_H_
#define _SAMG54_PDMIC0_INSTANCE_H_
...
#define REG_PDMIC0_DSPR         (0x4002C058) /**< (PDMIC0) DSP Configuration Register 0 */
...
#define REG_PDMIC0_DSPR         (*(__IO uint32_t*)0x4002C058U) /**< (PDMIC0) DSP Configuration Register 0 */
