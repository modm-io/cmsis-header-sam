...
#define MATRIX_PRBS_MASK                    _U_(0x33303)                                   /**< \deprecated (MATRIX_PRBS) Register MASK  (Use MATRIX_PRBS_Msk instead)  */
#define MATRIX_PRBS_Msk                     _U_(0x33303)                                   /**< (MATRIX_PRBS) Register Mask  */
...
#define MATRIX_MRCR_MASK                    _U_(0x1DFF)                                    /**< \deprecated (MATRIX_MRCR) Register MASK  (Use MATRIX_MRCR_Msk instead)  */
#define MATRIX_MRCR_Msk                     _U_(0x1DFF)                                    /**< (MATRIX_MRCR) Register Mask  */
