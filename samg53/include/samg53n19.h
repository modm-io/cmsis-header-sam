...
/******  SAMG53N19 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMG53N19 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 8  , /**< 8   SAMG53N19 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 9  , /**< 9   SAMG53N19 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 11 , /**< 11  SAMG53N19 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 12 , /**< 12  SAMG53N19 Parallel Input/Output Controller (PIOB) */
  PDMIC0_IRQn               = 13 , /**< 13  SAMG53N19 Pulse Density Modulation Interface Controller (PDMIC0) */
  USART_IRQn                = 14 , /**< 14  SAMG53N19 Universal Synchronous Asynchronous Receiver Transmitter (USART) */
  MEM2MEM_IRQn              = 15 , /**< 15  SAMG53N19 Memory to Memory (MEM2MEM) */
  I2SC0_IRQn                = 16 , /**< 16  SAMG53N19 Inter-IC Sound Controller (I2SC0) */
  I2SC1_IRQn                = 17 , /**< 17  SAMG53N19 Inter-IC Sound Controller (I2SC1) */
  PDMIC1_IRQn               = 18 , /**< 18  SAMG53N19 Pulse Density Modulation Interface Controller (PDMIC1) */
  TWI0_IRQn                 = 19 , /**< 19  SAMG53N19 Two-wire Interface High Speed (TWI0) */
  TWI1_IRQn                 = 20 , /**< 20  SAMG53N19 Two-wire Interface (TWI1) */
  SPI_IRQn                  = 21 , /**< 21  SAMG53N19 Serial Peripheral Interface (SPI) */
  TWI2_IRQn                 = 22 , /**< 22  SAMG53N19 Two-wire Interface (TWI2) */
  TC0_IRQn                  = 23 , /**< 23  SAMG53N19 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMG53N19 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMG53N19 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMG53N19 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMG53N19 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMG53N19 Timer Counter (TC1)       */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMG53N19 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMG53N19 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMG53N19 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMG53N19 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMG53N19 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMG53N19 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMG53N19 Embedded Flash Controller (EFC) */
  void* pvReserved7;
  void* pfnUART0_Handler;                        /* 8   SAMG53N19 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 9   SAMG53N19 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved10;
  void* pfnPIOA_Handler;                         /* 11  SAMG53N19 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 12  SAMG53N19 Parallel Input/Output Controller (PIOB) */
  void* pfnPDMIC0_Handler;                       /* 13  SAMG53N19 Pulse Density Modulation Interface Controller (PDMIC0) */
  void* pfnUSART_Handler;                        /* 14  SAMG53N19 Universal Synchronous Asynchronous Receiver Transmitter (USART) */
  void* pfnMEM2MEM_Handler;                      /* 15  SAMG53N19 Memory to Memory (MEM2MEM) */
  void* pfnI2SC0_Handler;                        /* 16  SAMG53N19 Inter-IC Sound Controller (I2SC0) */
  void* pfnI2SC1_Handler;                        /* 17  SAMG53N19 Inter-IC Sound Controller (I2SC1) */
  void* pfnPDMIC1_Handler;                       /* 18  SAMG53N19 Pulse Density Modulation Interface Controller (PDMIC1) */
  void* pfnTWI0_Handler;                         /* 19  SAMG53N19 Two-wire Interface High Speed (TWI0) */
  void* pfnTWI1_Handler;                         /* 20  SAMG53N19 Two-wire Interface (TWI1) */
  void* pfnSPI_Handler;                          /* 21  SAMG53N19 Serial Peripheral Interface (SPI) */
  void* pfnTWI2_Handler;                         /* 22  SAMG53N19 Two-wire Interface (TWI2) */
  void* pfnTC0_Handler;                          /* 23  SAMG53N19 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMG53N19 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMG53N19 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMG53N19 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMG53N19 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMG53N19 Timer Counter (TC1)  */
  void* pfnADC_Handler;                          /* 29  SAMG53N19 Analog-to-Digital Converter (ADC) */
} DeviceVectors;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
...
/** @}  end of SAMG53N19_cmsis CMSIS Definitions */
...
/** \defgroup SAMG53N19_reg Registers Access Definitions
 *  @{
 */
