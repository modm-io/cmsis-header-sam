...
#ifndef _SAMG53_PDMIC1_INSTANCE_H_
#define _SAMG53_PDMIC1_INSTANCE_H_
...
#define REG_PDMIC1_DSPR         (0x40030058) /**< (PDMIC1) DSP Configuration Register 0 */
...
#define REG_PDMIC1_DSPR         (*(__IO uint32_t*)0x40030058U) /**< (PDMIC1) DSP Configuration Register 0 */
