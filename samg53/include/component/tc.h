...
#ifndef _SAMG53_TC_COMPONENT_H_
#define _SAMG53_TC_COMPONENT_H_
#define _SAMG53_TC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG53 Timer Counter
 *  @{
 */
/* ========================================================================== */
...
#define TC_CMR_MASK                         _U_(0xFC7FF)                                   /**< \deprecated (TC_CMR) Register MASK  (Use TC_CMR_Msk instead)  */
#define TC_CMR_Msk                          _U_(0xFC7FF)                                   /**< (TC_CMR) Register Mask  */
