...
#ifndef _SAMG53_PDMIC_COMPONENT_H_
#define _SAMG53_PDMIC_COMPONENT_H_
#define _SAMG53_PDMIC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG53 Pulse Density Modulation Interface Controller
 *  @{
 */
/* ========================================================================== */
...
#define PDMIC_MR_MASK                       _U_(0x7F00)                                    /**< \deprecated (PDMIC_MR) Register MASK  (Use PDMIC_MR_Msk instead)  */
#define PDMIC_MR_Msk                        _U_(0x7F00)                                    /**< (PDMIC_MR) Register Mask  */
...
/* -------- PDMIC_DSPR : (PDMIC Offset: 0x58) (R/W 32) DSP Configuration Register 0 -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define PDMIC_DSPR_OFFSET                   (0x58)                                        /**<  (PDMIC_DSPR) DSP Configuration Register 0  Offset */

#define PDMIC_DSPR_HPFBYP_Pos               1                                              /**< (PDMIC_DSPR) High-Pass Filter Bypass Position */
#define PDMIC_DSPR_HPFBYP_Msk               (_U_(0x1) << PDMIC_DSPR_HPFBYP_Pos)            /**< (PDMIC_DSPR) High-Pass Filter Bypass Mask */
#define PDMIC_DSPR_HPFBYP                   PDMIC_DSPR_HPFBYP_Msk                          /**< \deprecated Old style mask definition for 1 bit bitfield. Use PDMIC_DSPR_HPFBYP_Msk instead */
#define PDMIC_DSPR_SINBYP_Pos               2                                              /**< (PDMIC_DSPR) SINCC Filter Bypass Position */
#define PDMIC_DSPR_SINBYP_Msk               (_U_(0x1) << PDMIC_DSPR_SINBYP_Pos)            /**< (PDMIC_DSPR) SINCC Filter Bypass Mask */
#define PDMIC_DSPR_SINBYP                   PDMIC_DSPR_SINBYP_Msk                          /**< \deprecated Old style mask definition for 1 bit bitfield. Use PDMIC_DSPR_SINBYP_Msk instead */
#define PDMIC_DSPR_SIZE_Pos                 3                                              /**< (PDMIC_DSPR) Data Size Position */
#define PDMIC_DSPR_SIZE_Msk                 (_U_(0x1) << PDMIC_DSPR_SIZE_Pos)              /**< (PDMIC_DSPR) Data Size Mask */
#define PDMIC_DSPR_SIZE                     PDMIC_DSPR_SIZE_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use PDMIC_DSPR_SIZE_Msk instead */
#define PDMIC_DSPR_OSR_Pos                  4                                              /**< (PDMIC_DSPR) Oversampling Ratio Position */
#define PDMIC_DSPR_OSR_Msk                  (_U_(0x7) << PDMIC_DSPR_OSR_Pos)               /**< (PDMIC_DSPR) Oversampling Ratio Mask */
#define PDMIC_DSPR_OSR(value)               (PDMIC_DSPR_OSR_Msk & ((value) << PDMIC_DSPR_OSR_Pos))
#define   PDMIC_DSPR_OSR_128_Val            _U_(0x0)                                       /**< (PDMIC_DSPR) Oversampling ratio is 128  */
#define   PDMIC_DSPR_OSR_64_Val             _U_(0x1)                                       /**< (PDMIC_DSPR) Oversampling ratio is 64  */
#define PDMIC_DSPR_OSR_128                  (PDMIC_DSPR_OSR_128_Val << PDMIC_DSPR_OSR_Pos)  /**< (PDMIC_DSPR) Oversampling ratio is 128 Position  */
#define PDMIC_DSPR_OSR_64                   (PDMIC_DSPR_OSR_64_Val << PDMIC_DSPR_OSR_Pos)  /**< (PDMIC_DSPR) Oversampling ratio is 64 Position  */
#define PDMIC_DSPR_SCALE_Pos                8                                              /**< (PDMIC_DSPR) Data Scale Position */
#define PDMIC_DSPR_SCALE_Msk                (_U_(0xF) << PDMIC_DSPR_SCALE_Pos)             /**< (PDMIC_DSPR) Data Scale Mask */
#define PDMIC_DSPR_SCALE(value)             (PDMIC_DSPR_SCALE_Msk & ((value) << PDMIC_DSPR_SCALE_Pos))
#define PDMIC_DSPR_SHIFT_Pos                12                                             /**< (PDMIC_DSPR) Data Shift Position */
#define PDMIC_DSPR_SHIFT_Msk                (_U_(0xF) << PDMIC_DSPR_SHIFT_Pos)             /**< (PDMIC_DSPR) Data Shift Mask */
#define PDMIC_DSPR_SHIFT(value)             (PDMIC_DSPR_SHIFT_Msk & ((value) << PDMIC_DSPR_SHIFT_Pos))
#define PDMIC_DSPR_MASK                     _U_(0xFF7E)                                    /**< \deprecated (PDMIC_DSPR) Register MASK  (Use PDMIC_DSPR_Msk instead)  */
#define PDMIC_DSPR_Msk                      _U_(0xFF7E)                                    /**< (PDMIC_DSPR) Register Mask  */
...
typedef struct {
  ...
  __IO uint32_t PDMIC_DSPR[2];  /**< (PDMIC Offset: 0x58) DSP Configuration Register 0 */
...
typedef struct {
  ...
  __IO PDMIC_DSPR_Type                PDMIC_DSPR[2];  /**< Offset: 0x58 (R/W  32) DSP Configuration Register 0 */
...
#endif /* _SAMG53_PDMIC_COMPONENT_H_ */
