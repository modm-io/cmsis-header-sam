...
#ifndef _SAMG51_TC0_INSTANCE_H_
#define _SAMG51_TC0_INSTANCE_H_
...
#define REG_TC0_RPR2            (0x40010180) /**< (TC0) Receive Pointer Register (pdc = 2) */
#define REG_TC0_RNPR2           (0x40010190) /**< (TC0) Receive Next Pointer Register (pdc = 2) */
#define REG_TC0_RNCR2           (0x40010194) /**< (TC0) Receive Next Counter Register (pdc = 2) */
#define REG_TC0_PTCR2           (0x400101A0) /**< (TC0) Transfer Control Register (pdc = 2) */
#define REG_TC0_PTSR2           (0x400101A4) /**< (TC0) Transfer Status Register (pdc = 2) */
...
#define REG_TC0_RPR2            (*(__IO uint32_t*)0x40010180U) /**< (TC0) Receive Pointer Register (pdc = 2) */
#define REG_TC0_RNPR2           (*(__IO uint32_t*)0x40010190U) /**< (TC0) Receive Next Pointer Register (pdc = 2) */
#define REG_TC0_RNCR2           (*(__IO uint32_t*)0x40010194U) /**< (TC0) Receive Next Counter Register (pdc = 2) */
#define REG_TC0_PTCR2           (*(__O  uint32_t*)0x400101A0U) /**< (TC0) Transfer Control Register (pdc = 2) */
#define REG_TC0_PTSR2           (*(__I  uint32_t*)0x400101A4U) /**< (TC0) Transfer Status Register (pdc = 2) */
