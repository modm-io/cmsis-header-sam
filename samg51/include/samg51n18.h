 ...
 * \file
 *
 * \brief Header file for ATSAMG51N18
 *
...
#ifndef _SAMG51N18_H_
#define _SAMG51N18_H_
...
/******  SAMG51N18 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMG51N18 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 8  , /**< 8   SAMG51N18 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 9  , /**< 9   SAMG51N18 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 11 , /**< 11  SAMG51N18 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 12 , /**< 12  SAMG51N18 Parallel Input/Output Controller (PIOB) */
  USART_IRQn                = 14 , /**< 14  SAMG51N18 Universal Synchronous Asynchronous Receiver Transmitter (USART) */
  MEM2MEM_IRQn              = 15 , /**< 15  SAMG51N18 Memory to Memory (MEM2MEM) */
  TWI0_IRQn                 = 19 , /**< 19  SAMG51N18 Two-wire Interface High Speed (TWI0) */
  TWI1_IRQn                 = 20 , /**< 20  SAMG51N18 Two-wire Interface (TWI1) */
  SPI_IRQn                  = 21 , /**< 21  SAMG51N18 Serial Peripheral Interface (SPI) */
  TWI2_IRQn                 = 22 , /**< 22  SAMG51N18 Two-wire Interface (TWI2) */
  TC0_IRQn                  = 23 , /**< 23  SAMG51N18 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMG51N18 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMG51N18 Timer Counter (TC0)       */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMG51N18 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMG51N18 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMG51N18 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMG51N18 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMG51N18 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMG51N18 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMG51N18 Embedded Flash Controller (EFC) */
  void* pvReserved7;
  void* pfnUART0_Handler;                        /* 8   SAMG51N18 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 9   SAMG51N18 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved10;
  void* pfnPIOA_Handler;                         /* 11  SAMG51N18 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 12  SAMG51N18 Parallel Input/Output Controller (PIOB) */
  void* pvReserved13;
  void* pfnUSART_Handler;                        /* 14  SAMG51N18 Universal Synchronous Asynchronous Receiver Transmitter (USART) */
  void* pfnMEM2MEM_Handler;                      /* 15  SAMG51N18 Memory to Memory (MEM2MEM) */
  void* pvReserved16;
  void* pvReserved17;
  void* pvReserved18;
  void* pfnTWI0_Handler;                         /* 19  SAMG51N18 Two-wire Interface High Speed (TWI0) */
  void* pfnTWI1_Handler;                         /* 20  SAMG51N18 Two-wire Interface (TWI1) */
  void* pfnSPI_Handler;                          /* 21  SAMG51N18 Serial Peripheral Interface (SPI) */
  void* pfnTWI2_Handler;                         /* 22  SAMG51N18 Two-wire Interface (TWI2) */
  void* pfnTC0_Handler;                          /* 23  SAMG51N18 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMG51N18 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMG51N18 Timer Counter (TC0)  */
  void* pvReserved26;
  void* pvReserved27;
  void* pvReserved28;
  void* pfnADC_Handler;                          /* 29  SAMG51N18 Analog-to-Digital Converter (ADC) */
} DeviceVectors;
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
...
/** @}  end of SAMG51N18_cmsis CMSIS Definitions */

/** \defgroup SAMG51N18_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMG51N18_reg Registers Access Definitions
 *  @{
 */
...
#define TC_INST_NUM            1                              /**< \brief (TC        ) Number of instances */
#define TC_INSTS               { TC0 }                        /**< \brief (TC        ) Instances List */
...
#define IFLASH_SIZE              _U_(0x00040000)       /*  256kB Memory segment type: flash */
#define IFLASH_PAGE_SIZE         _U_(       512)
#define IFLASH_NB_OF_PAGES       _U_(       512)

#define IROM_SIZE                _U_(0x00400000)       /* 4096kB Memory segment type: rom */
#define IRAM_SIZE                _U_(0x00010000)       /*   64kB Memory segment type: ram */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMG51N18 */
/* ************************************************************************** */
#define JTAGID                   _UL_(0X05B3A03F)
#define CHIP_JTAGID              _UL_(0X05B3A03F)
#define CHIP_CIDR                _UL_(0X243B09E8)
...
#define CHIP_FREQ_FWS_0                _UL_(15000000)  /**< \brief Maximum operating frequency when FWS is 0*/
#define CHIP_FREQ_FWS_1                _UL_(30000000)  /**< \brief Maximum operating frequency when FWS is 1*/
#define CHIP_FREQ_FWS_2                _UL_(45000000)  /**< \brief Maximum operating frequency when FWS is 2*/
#define CHIP_FREQ_FWS_3                _UL_(60000000)  /**< \brief Maximum operating frequency when FWS is 3*/
