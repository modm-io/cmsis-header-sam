...
#ifndef _SAMG51_PDC_COMPONENT_H_
#define _SAMG51_PDC_COMPONENT_H_
#define _SAMG51_PDC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Peripheral DMA Controller
 *  @{
 */
/* ========================================================================== */
...
#define PDC_PERIPH_PTCR_MASK                _U_(0x303)                                     /**< \deprecated (PDC_PERIPH_PTCR) Register MASK  (Use PDC_PERIPH_PTCR_Msk instead)  */
#define PDC_PERIPH_PTCR_Msk                 _U_(0x303)                                     /**< (PDC_PERIPH_PTCR) Register Mask  */
...
#define PDC_PERIPH_PTSR_MASK                _U_(0x101)                                     /**< \deprecated (PDC_PERIPH_PTSR) Register MASK  (Use PDC_PERIPH_PTSR_Msk instead)  */
#define PDC_PERIPH_PTSR_Msk                 _U_(0x101)                                     /**< (PDC_PERIPH_PTSR) Register Mask  */
...
#endif /* _SAMG51_PDC_COMPONENT_H_ */
