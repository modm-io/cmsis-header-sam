...
#define _SAMG51_SUPC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Supply Controller
 *  @{
 */
/* ========================================================================== */
...
#define REV_SUPC F                      /**< (SUPC) Module revision */
...
#define SUPC_MR_MASK                        _U_(0xFF103000)                                /**< \deprecated (SUPC_MR) Register MASK  (Use SUPC_MR_Msk instead)  */
