...
#ifndef _SAMG51_TC_COMPONENT_H_
#define _SAMG51_TC_COMPONENT_H_
#define _SAMG51_TC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Timer Counter
 *  @{
 */
/* ========================================================================== */
...
/* -------- TC_RPR2 : (TC Offset: 0x180) (R/W 32) Receive Pointer Register (pdc = 2) -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_RPR2_OFFSET                      (0x180)                                       /**<  (TC_RPR2) Receive Pointer Register (pdc = 2)  Offset */

#define TC_RPR2_RXPTR_Pos                   0                                              /**< (TC_RPR2) Receive Pointer Register Position */
#define TC_RPR2_RXPTR_Msk                   (_U_(0xFFFFFFFF) << TC_RPR2_RXPTR_Pos)         /**< (TC_RPR2) Receive Pointer Register Mask */
#define TC_RPR2_RXPTR(value)                (TC_RPR2_RXPTR_Msk & ((value) << TC_RPR2_RXPTR_Pos))
#define TC_RPR2_MASK                        _U_(0xFFFFFFFF)                                /**< \deprecated (TC_RPR2) Register MASK  (Use TC_RPR2_Msk instead)  */
#define TC_RPR2_Msk                         _U_(0xFFFFFFFF)                                /**< (TC_RPR2) Register Mask  */


/* -------- TC_RNPR2 : (TC Offset: 0x190) (R/W 32) Receive Next Pointer Register (pdc = 2) -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_RNPR2_OFFSET                     (0x190)                                       /**<  (TC_RNPR2) Receive Next Pointer Register (pdc = 2)  Offset */

#define TC_RNPR2_RXNPTR_Pos                 0                                              /**< (TC_RNPR2) Receive Next Pointer Position */
#define TC_RNPR2_RXNPTR_Msk                 (_U_(0xFFFFFFFF) << TC_RNPR2_RXNPTR_Pos)       /**< (TC_RNPR2) Receive Next Pointer Mask */
#define TC_RNPR2_RXNPTR(value)              (TC_RNPR2_RXNPTR_Msk & ((value) << TC_RNPR2_RXNPTR_Pos))
#define TC_RNPR2_MASK                       _U_(0xFFFFFFFF)                                /**< \deprecated (TC_RNPR2) Register MASK  (Use TC_RNPR2_Msk instead)  */
#define TC_RNPR2_Msk                        _U_(0xFFFFFFFF)                                /**< (TC_RNPR2) Register Mask  */


/* -------- TC_RNCR2 : (TC Offset: 0x194) (R/W 32) Receive Next Counter Register (pdc = 2) -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_RNCR2_OFFSET                     (0x194)                                       /**<  (TC_RNCR2) Receive Next Counter Register (pdc = 2)  Offset */

#define TC_RNCR2_RXNCTR_Pos                 0                                              /**< (TC_RNCR2) Receive Next Counter Position */
#define TC_RNCR2_RXNCTR_Msk                 (_U_(0xFFFF) << TC_RNCR2_RXNCTR_Pos)           /**< (TC_RNCR2) Receive Next Counter Mask */
#define TC_RNCR2_RXNCTR(value)              (TC_RNCR2_RXNCTR_Msk & ((value) << TC_RNCR2_RXNCTR_Pos))
#define TC_RNCR2_MASK                       _U_(0xFFFF)                                    /**< \deprecated (TC_RNCR2) Register MASK  (Use TC_RNCR2_Msk instead)  */
#define TC_RNCR2_Msk                        _U_(0xFFFF)                                    /**< (TC_RNCR2) Register Mask  */


/* -------- TC_PTCR2 : (TC Offset: 0x1a0) (/W 32) Transfer Control Register (pdc = 2) -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_PTCR2_OFFSET                     (0x1A0)                                       /**<  (TC_PTCR2) Transfer Control Register (pdc = 2)  Offset */

#define TC_PTCR2_RXTEN_Pos                  0                                              /**< (TC_PTCR2) Receiver Transfer Enable Position */
#define TC_PTCR2_RXTEN_Msk                  (_U_(0x1) << TC_PTCR2_RXTEN_Pos)               /**< (TC_PTCR2) Receiver Transfer Enable Mask */
#define TC_PTCR2_RXTEN                      TC_PTCR2_RXTEN_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTCR2_RXTEN_Msk instead */
#define TC_PTCR2_RXTDIS_Pos                 1                                              /**< (TC_PTCR2) Receiver Transfer Disable Position */
#define TC_PTCR2_RXTDIS_Msk                 (_U_(0x1) << TC_PTCR2_RXTDIS_Pos)              /**< (TC_PTCR2) Receiver Transfer Disable Mask */
#define TC_PTCR2_RXTDIS                     TC_PTCR2_RXTDIS_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTCR2_RXTDIS_Msk instead */
#define TC_PTCR2_TXTEN_Pos                  8                                              /**< (TC_PTCR2) Transmitter Transfer Enable Position */
#define TC_PTCR2_TXTEN_Msk                  (_U_(0x1) << TC_PTCR2_TXTEN_Pos)               /**< (TC_PTCR2) Transmitter Transfer Enable Mask */
#define TC_PTCR2_TXTEN                      TC_PTCR2_TXTEN_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTCR2_TXTEN_Msk instead */
#define TC_PTCR2_TXTDIS_Pos                 9                                              /**< (TC_PTCR2) Transmitter Transfer Disable Position */
#define TC_PTCR2_TXTDIS_Msk                 (_U_(0x1) << TC_PTCR2_TXTDIS_Pos)              /**< (TC_PTCR2) Transmitter Transfer Disable Mask */
#define TC_PTCR2_TXTDIS                     TC_PTCR2_TXTDIS_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTCR2_TXTDIS_Msk instead */
#define TC_PTCR2_MASK                       _U_(0x303)                                     /**< \deprecated (TC_PTCR2) Register MASK  (Use TC_PTCR2_Msk instead)  */
#define TC_PTCR2_Msk                        _U_(0x303)                                     /**< (TC_PTCR2) Register Mask  */


/* -------- TC_PTSR2 : (TC Offset: 0x1a4) (R/ 32) Transfer Status Register (pdc = 2) -------- */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
    uint32_t RXTEN:1;                   /**< bit:      0  Receiver Transfer Enable                 */
...
#define TC_PTSR2_OFFSET                     (0x1A4)                                       /**<  (TC_PTSR2) Transfer Status Register (pdc = 2)  Offset */

#define TC_PTSR2_RXTEN_Pos                  0                                              /**< (TC_PTSR2) Receiver Transfer Enable Position */
#define TC_PTSR2_RXTEN_Msk                  (_U_(0x1) << TC_PTSR2_RXTEN_Pos)               /**< (TC_PTSR2) Receiver Transfer Enable Mask */
#define TC_PTSR2_RXTEN                      TC_PTSR2_RXTEN_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTSR2_RXTEN_Msk instead */
#define TC_PTSR2_TXTEN_Pos                  8                                              /**< (TC_PTSR2) Transmitter Transfer Enable Position */
#define TC_PTSR2_TXTEN_Msk                  (_U_(0x1) << TC_PTSR2_TXTEN_Pos)               /**< (TC_PTSR2) Transmitter Transfer Enable Mask */
#define TC_PTSR2_TXTEN                      TC_PTSR2_TXTEN_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use TC_PTSR2_TXTEN_Msk instead */
#define TC_PTSR2_MASK                       _U_(0x101)                                     /**< \deprecated (TC_PTSR2) Register MASK  (Use TC_PTSR2_Msk instead)  */
#define TC_PTSR2_Msk                        _U_(0x101)                                     /**< (TC_PTSR2) Register Mask  */
...
typedef struct {
  ...
  RoReg8  Reserved2[0x98];
  __IO uint32_t TC_RPR2;        /**< (TC Offset: 0x180) Receive Pointer Register (pdc = 2) */
  RoReg8  Reserved3[0xC];
  __IO uint32_t TC_RNPR2;       /**< (TC Offset: 0x190) Receive Next Pointer Register (pdc = 2) */
  __IO uint32_t TC_RNCR2;       /**< (TC Offset: 0x194) Receive Next Counter Register (pdc = 2) */
  RoReg8  Reserved4[0x8];
  __O  uint32_t TC_PTCR2;       /**< (TC Offset: 0x1A0) Transfer Control Register (pdc = 2) */
  __I  uint32_t TC_PTSR2;       /**< (TC Offset: 0x1A4) Transfer Status Register (pdc = 2) */
} Tc;
...
typedef struct {
  ...
  __IO TC_RPR2_Type                   TC_RPR2;        /**< Offset: 0x180 (R/W  32) Receive Pointer Register (pdc = 2) */
  __I  uint32_t                       Reserved3[3];
  __IO TC_RNPR2_Type                  TC_RNPR2;       /**< Offset: 0x190 (R/W  32) Receive Next Pointer Register (pdc = 2) */
  __IO TC_RNCR2_Type                  TC_RNCR2;       /**< Offset: 0x194 (R/W  32) Receive Next Counter Register (pdc = 2) */
  __I  uint32_t                       Reserved4[2];
  __O  TC_PTCR2_Type                  TC_PTCR2;       /**< Offset: 0x1A0 ( /W  32) Transfer Control Register (pdc = 2) */
  __I  TC_PTSR2_Type                  TC_PTSR2;       /**< Offset: 0x1A4 (R/   32) Transfer Status Register (pdc = 2) */
} Tc;
