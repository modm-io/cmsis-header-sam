...
#ifndef _SAMG51_SPI_COMPONENT_H_
#define _SAMG51_SPI_COMPONENT_H_
#define _SAMG51_SPI_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Serial Peripheral Interface
 *  @{
 */
/* ========================================================================== */
...
#define REV_SPI ZE                     /**< (SPI) Module revision */
...
#define SPI_CR_MASK                         _U_(0x1000083)                                 /**< \deprecated (SPI_CR) Register MASK  (Use SPI_CR_Msk instead)  */
#define SPI_CR_Msk                          _U_(0x1000083)                                 /**< (SPI_CR) Register Mask  */
...
#define SPI_MR_MASK                         _U_(0xFF0300B7)                                /**< \deprecated (SPI_MR) Register MASK  (Use SPI_MR_Msk instead)  */
#define SPI_MR_Msk                          _U_(0xFF0300B7)                                /**< (SPI_MR) Register Mask  */
...
#define SPI_SR_MASK                         _U_(0x107FF)                                   /**< \deprecated (SPI_SR) Register MASK  (Use SPI_SR_Msk instead)  */
#define SPI_SR_Msk                          _U_(0x107FF)                                   /**< (SPI_SR) Register Mask  */
...
#define SPI_IER_MASK                        _U_(0x7FF)                                     /**< \deprecated (SPI_IER) Register MASK  (Use SPI_IER_Msk instead)  */
#define SPI_IER_Msk                         _U_(0x7FF)                                     /**< (SPI_IER) Register Mask  */
...
#define SPI_IDR_MASK                        _U_(0x7FF)                                     /**< \deprecated (SPI_IDR) Register MASK  (Use SPI_IDR_Msk instead)  */
#define SPI_IDR_Msk                         _U_(0x7FF)                                     /**< (SPI_IDR) Register Mask  */
...
#define SPI_IMR_MASK                        _U_(0x7FF)                                     /**< \deprecated (SPI_IMR) Register MASK  (Use SPI_IMR_Msk instead)  */
#define SPI_IMR_Msk                         _U_(0x7FF)                                     /**< (SPI_IMR) Register Mask  */
...
#define SPI_CSR_SCBR_Pos                    8                                              /**< (SPI_CSR) Serial Clock Baud Rate Position */
#define SPI_CSR_SCBR_Msk                    (_U_(0xFF) << SPI_CSR_SCBR_Pos)                /**< (SPI_CSR) Serial Clock Baud Rate Mask */
...
#define SPI_PTCR_MASK                       _U_(0x303)                                     /**< \deprecated (SPI_PTCR) Register MASK  (Use SPI_PTCR_Msk instead)  */
#define SPI_PTCR_Msk                        _U_(0x303)                                     /**< (SPI_PTCR) Register Mask  */
...
#define SPI_PTSR_MASK                       _U_(0x101)                                     /**< \deprecated (SPI_PTSR) Register MASK  (Use SPI_PTSR_Msk instead)  */
#define SPI_PTSR_Msk                        _U_(0x101)                                     /**< (SPI_PTSR) Register Mask  */
...
typedef struct {
  ...
  __IO uint32_t SPI_CSR[2];     /**< (SPI Offset: 0x30) Chip Select Register 0 */
...
typedef struct {
  ...
  __IO SPI_CSR_Type                   SPI_CSR[2];     /**< Offset: 0x30 (R/W  32) Chip Select Register 0 */
...
#endif /* _SAMG51_SPI_COMPONENT_H_ */
