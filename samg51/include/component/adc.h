...
#define _SAMG51_ADC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Analog-to-Digital Converter
 *  @{
 */
/* ========================================================================== */
...
typedef union {
  struct {
    ...
    uint32_t AUTOCAL:1;                 /**< bit:      3  Automatic Calibration of ADC             */
...
#define ADC_CR_AUTOCAL_Pos                  3                                              /**< (ADC_CR) Automatic Calibration of ADC Position */
#define ADC_CR_AUTOCAL_Msk                  (_U_(0x1) << ADC_CR_AUTOCAL_Pos)               /**< (ADC_CR) Automatic Calibration of ADC Mask */
#define ADC_CR_AUTOCAL                      ADC_CR_AUTOCAL_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_CR_AUTOCAL_Msk instead */
#define ADC_CR_MASK                         _U_(0x0B)                                      /**< \deprecated (ADC_CR) Register MASK  (Use ADC_CR_Msk instead)  */
#define ADC_CR_Msk                          _U_(0x0B)                                      /**< (ADC_CR) Register Mask  */
...
typedef union {
  struct {
    ...
    uint32_t LOWRES:1;                  /**< bit:      4  Resolution                               */
    ...
    uint32_t DIV1:1;                    /**< bit:     22  ADC Clock Prescaler Division forced to 1 */
    uint32_t :1;                        /**< bit:     23  Reserved */
    uint32_t TRACKTIM:4;                /**< bit: 24..27  Tracking Time                            */
    uint32_t TRANSFER:2;                /**< bit: 28..29  Transfer Period                          */
    uint32_t DIV3:1;                    /**< bit:     30  ADC Clock Prescaler Division forced to 3 */
...
#define ADC_MR_LOWRES_Pos                   4                                              /**< (ADC_MR) Resolution Position */
#define ADC_MR_LOWRES_Msk                   (_U_(0x1) << ADC_MR_LOWRES_Pos)                /**< (ADC_MR) Resolution Mask */
#define ADC_MR_LOWRES                       ADC_MR_LOWRES_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_LOWRES_Msk instead */
...
#define ADC_MR_DIV1_Pos                     22                                             /**< (ADC_MR) ADC Clock Prescaler Division forced to 1 Position */
#define ADC_MR_DIV1_Msk                     (_U_(0x1) << ADC_MR_DIV1_Pos)                  /**< (ADC_MR) ADC Clock Prescaler Division forced to 1 Mask */
#define ADC_MR_DIV1                         ADC_MR_DIV1_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_DIV1_Msk instead */
...
#define ADC_MR_DIV3_Pos                     30                                             /**< (ADC_MR) ADC Clock Prescaler Division forced to 3 Position */
#define ADC_MR_DIV3_Msk                     (_U_(0x1) << ADC_MR_DIV3_Pos)                  /**< (ADC_MR) ADC Clock Prescaler Division forced to 3 Mask */
#define ADC_MR_DIV3                         ADC_MR_DIV3_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_MR_DIV3_Msk instead */
...
#define ADC_MR_MASK                         _U_(0xFF4FFFBF)                                /**< \deprecated (ADC_MR) Register MASK  (Use ADC_MR_Msk instead)  */
...
typedef union {
  struct {
    uint32_t LDATA:12;                  /**< bit:  0..11  Last Data Converted                      */
    uint32_t CHNB:4;                    /**< bit: 12..15  Channel Number                           */
...
#define ADC_LCDR_CHNB_Pos                   12                                             /**< (ADC_LCDR) Channel Number Position */
...
#define ADC_LCDR_MASK                       _U_(0xFFFF)                                    /**< \deprecated (ADC_LCDR) Register MASK  (Use ADC_LCDR_Msk instead)  */
#define ADC_LCDR_Msk                        _U_(0xFFFF)                                    /**< (ADC_LCDR) Register Mask  */
...
typedef union {
  struct {
    ...
    uint32_t EOCAL:1;                   /**< bit:     23  End of Calibration Sequence              */
...
#define ADC_IER_EOCAL_Pos                   23                                             /**< (ADC_IER) End of Calibration Sequence Position */
#define ADC_IER_EOCAL_Msk                   (_U_(0x1) << ADC_IER_EOCAL_Pos)                /**< (ADC_IER) End of Calibration Sequence Mask */
#define ADC_IER_EOCAL                       ADC_IER_EOCAL_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_IER_EOCAL_Msk instead */
...
#define ADC_IER_MASK                        _U_(0x1F8800FF)                                /**< \deprecated (ADC_IER) Register MASK  (Use ADC_IER_Msk instead)  */
...
#define ADC_IDR_EOCAL_Pos                   23                                             /**< (ADC_IDR) End of Calibration Sequence Position */
#define ADC_IDR_EOCAL_Msk                   (_U_(0x1) << ADC_IDR_EOCAL_Pos)                /**< (ADC_IDR) End of Calibration Sequence Mask */
#define ADC_IDR_EOCAL                       ADC_IDR_EOCAL_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_IDR_EOCAL_Msk instead */
...
#define ADC_IDR_MASK                        _U_(0x1F8800FF)                                /**< \deprecated (ADC_IDR) Register MASK  (Use ADC_IDR_Msk instead)  */
...
#define ADC_IMR_EOCAL_Pos                   23                                             /**< (ADC_IMR) End of Calibration Sequence Position */
#define ADC_IMR_EOCAL_Msk                   (_U_(0x1) << ADC_IMR_EOCAL_Pos)                /**< (ADC_IMR) End of Calibration Sequence Mask */
#define ADC_IMR_EOCAL                       ADC_IMR_EOCAL_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_IMR_EOCAL_Msk instead */
...
#define ADC_IMR_MASK                        _U_(0x1F8800FF)                                /**< \deprecated (ADC_IMR) Register MASK  (Use ADC_IMR_Msk instead)  */
...
#define ADC_ISR_EOCAL_Pos                   23                                             /**< (ADC_ISR) End of Calibration Sequence Position */
#define ADC_ISR_EOCAL_Msk                   (_U_(0x1) << ADC_ISR_EOCAL_Pos)                /**< (ADC_ISR) End of Calibration Sequence Mask */
#define ADC_ISR_EOCAL                       ADC_ISR_EOCAL_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use ADC_ISR_EOCAL_Msk instead */
...
#define ADC_ISR_MASK                        _U_(0x1F8800FF)                                /**< \deprecated (ADC_ISR) Register MASK  (Use ADC_ISR_Msk instead)  */
...
#define ADC_EMR_MASK                        _U_(0x11332F3)                                 /**< \deprecated (ADC_EMR) Register MASK  (Use ADC_EMR_Msk instead)  */
#define ADC_EMR_Msk                         _U_(0x11332F3)                                 /**< (ADC_EMR) Register Mask  */
...
#define ADC_CWR_MASK                        _U_(0xFFF0FFF)                                 /**< \deprecated (ADC_CWR) Register MASK  (Use ADC_CWR_Msk instead)  */
#define ADC_CWR_Msk                         _U_(0xFFF0FFF)                                 /**< (ADC_CWR) Register Mask  */
...
typedef union {
  struct {
    uint32_t DATA:12;                   /**< bit:  0..11  Converted Data                           */
...
#define ADC_CDR_MASK                        _U_(0xFFF)                                     /**< \deprecated (ADC_CDR) Register MASK  (Use ADC_CDR_Msk instead)  */
#define ADC_CDR_Msk                         _U_(0xFFF)                                     /**< (ADC_CDR) Register Mask  */
...
#define ADC_PTCR_MASK                       _U_(0x303)                                     /**< \deprecated (ADC_PTCR) Register MASK  (Use ADC_PTCR_Msk instead)  */
#define ADC_PTCR_Msk                        _U_(0x303)                                     /**< (ADC_PTCR) Register Mask  */
...
#define ADC_PTSR_MASK                       _U_(0x101)                                     /**< \deprecated (ADC_PTSR) Register MASK  (Use ADC_PTSR_Msk instead)  */
#define ADC_PTSR_Msk                        _U_(0x101)                                     /**< (ADC_PTSR) Register Mask  */
