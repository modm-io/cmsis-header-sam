...
#ifndef _SAMG51_TWI_COMPONENT_H_
#define _SAMG51_TWI_COMPONENT_H_
#define _SAMG51_TWI_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMG_SAMG51 Two-wire Interface
 *  @{
 */
/* ========================================================================== */
...
#define TWI_PTCR_MASK                       _U_(0x303)                                     /**< \deprecated (TWI_PTCR) Register MASK  (Use TWI_PTCR_Msk instead)  */
#define TWI_PTCR_Msk                        _U_(0x303)                                     /**< (TWI_PTCR) Register Mask  */
...
#define TWI_PTSR_MASK                       _U_(0x101)                                     /**< \deprecated (TWI_PTSR) Register MASK  (Use TWI_PTSR_Msk instead)  */
#define TWI_PTSR_Msk                        _U_(0x101)                                     /**< (TWI_PTSR) Register Mask  */
...
#endif /* _SAMG51_TWI_COMPONENT_H_ */
