...
#define _SAMV70_WDT_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMV_SAMV70 Watchdog Timer
 *  @{
 */
/* ========================================================================== */
...
#define WDT_CR_LOCKMR                       WDT_CR_LOCKMR_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use WDT_CR_LOCKMR_Msk instead */
...
#define WDT_CR_MASK                         _U_(0xFF000011)                                /**< \deprecated (WDT_CR) Register MASK  (Use WDT_CR_Msk instead)  */
