 ...
 * \file
 *
 * \brief Header file for ATSAMV70J19
 *
...
#ifndef _SAMV70J19_H_
#define _SAMV70J19_H_
...
/******  SAMV70J19 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMV70J19 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAMV70J19 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAMV70J19 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAMV70J19 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAMV70J19 Parallel Input/Output Controller (PIOB) */
  USART0_IRQn               = 13 , /**< 13  SAMV70J19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAMV70J19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  PIOD_IRQn                 = 16 , /**< 16  SAMV70J19 Parallel Input/Output Controller (PIOD) */
  HSMCI_IRQn                = 18 , /**< 18  SAMV70J19 High Speed MultiMedia Card Interface (HSMCI) */
  TWIHS0_IRQn               = 19 , /**< 19  SAMV70J19 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAMV70J19 Two-wire Interface High Speed (TWIHS1) */
  SSC_IRQn                  = 22 , /**< 22  SAMV70J19 Synchronous Serial Controller (SSC) */
  TC0_IRQn                  = 23 , /**< 23  SAMV70J19 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMV70J19 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMV70J19 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMV70J19 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMV70J19 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMV70J19 Timer Counter (TC1)       */
  AFEC0_IRQn                = 29 , /**< 29  SAMV70J19 Analog Front-End Controller (AFEC0) */
  DACC_IRQn                 = 30 , /**< 30  SAMV70J19 Digital-to-Analog Converter Controller (DACC) */
  PWM0_IRQn                 = 31 , /**< 31  SAMV70J19 Pulse Width Modulation Controller (PWM0) */
  ICM_IRQn                  = 32 , /**< 32  SAMV70J19 Integrity Check Monitor (ICM) */
  ACC_IRQn                  = 33 , /**< 33  SAMV70J19 Analog Comparator Controller (ACC) */
  USBHS_IRQn                = 34 , /**< 34  SAMV70J19 USB High-Speed Interface (USBHS) */
  ...
  MCAN1_INT0_IRQn           = 37 , /**< 37  SAMV70J19 Controller Area Network (MCAN1) */
  MCAN1_INT1_IRQn           = 38 , /**< 38  SAMV70J19 Controller Area Network (MCAN1) */
  AFEC1_IRQn                = 40 , /**< 40  SAMV70J19 Analog Front-End Controller (AFEC1) */
  QSPI_IRQn                 = 43 , /**< 43  SAMV70J19 Quad Serial Peripheral Interface (QSPI) */
  UART2_IRQn                = 44 , /**< 44  SAMV70J19 Universal Asynchronous Receiver Transmitter (UART2) */
  TC6_IRQn                  = 47 , /**< 47  SAMV70J19 Timer Counter (TC2)       */
  TC7_IRQn                  = 48 , /**< 48  SAMV70J19 Timer Counter (TC2)       */
  TC8_IRQn                  = 49 , /**< 49  SAMV70J19 Timer Counter (TC2)       */
  TC9_IRQn                  = 50 , /**< 50  SAMV70J19 Timer Counter (TC3)       */
  TC10_IRQn                 = 51 , /**< 51  SAMV70J19 Timer Counter (TC3)       */
  TC11_IRQn                 = 52 , /**< 52  SAMV70J19 Timer Counter (TC3)       */
  MLB_IRQn                  = 53 , /**< 53  SAMV70J19 Media LB (MLB)            */
  AES_IRQn                  = 56 , /**< 56  SAMV70J19 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAMV70J19 True Random Number Generator (TRNG) */
  XDMAC_IRQn                = 58 , /**< 58  SAMV70J19 Extensible DMA Controller (XDMAC) */
  ISI_IRQn                  = 59 , /**< 59  SAMV70J19 Image Sensor Interface (ISI) */
  PWM1_IRQn                 = 60 , /**< 60  SAMV70J19 Pulse Width Modulation Controller (PWM1) */
  FPU_IRQn                  = 61 , /**< 61  SAMV70J19 Floating Point Unit (FPU) */
  RSWDT_IRQn                = 63 , /**< 63  SAMV70J19 Reinforced Safety Watchdog Timer (RSWDT) */
  IXC_IRQn                  = 68 , /**< 68  SAMV70J19 Floating Point Unit (FPU) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMV70J19 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMV70J19 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMV70J19 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMV70J19 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMV70J19 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMV70J19 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMV70J19 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAMV70J19 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAMV70J19 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAMV70J19 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAMV70J19 Parallel Input/Output Controller (PIOB) */
  void* pvReserved12;
  void* pfnUSART0_Handler;                       /* 13  SAMV70J19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAMV70J19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pvReserved15;
  void* pfnPIOD_Handler;                         /* 16  SAMV70J19 Parallel Input/Output Controller (PIOD) */
  void* pvReserved17;
  void* pfnHSMCI_Handler;                        /* 18  SAMV70J19 High Speed MultiMedia Card Interface (HSMCI) */
  void* pfnTWIHS0_Handler;                       /* 19  SAMV70J19 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAMV70J19 Two-wire Interface High Speed (TWIHS1) */
  void* pvReserved21;
  void* pfnSSC_Handler;                          /* 22  SAMV70J19 Synchronous Serial Controller (SSC) */
  void* pfnTC0_Handler;                          /* 23  SAMV70J19 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMV70J19 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMV70J19 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMV70J19 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMV70J19 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMV70J19 Timer Counter (TC1)  */
  void* pfnAFEC0_Handler;                        /* 29  SAMV70J19 Analog Front-End Controller (AFEC0) */
  void* pfnDACC_Handler;                         /* 30  SAMV70J19 Digital-to-Analog Converter Controller (DACC) */
  void* pfnPWM0_Handler;                         /* 31  SAMV70J19 Pulse Width Modulation Controller (PWM0) */
  void* pfnICM_Handler;                          /* 32  SAMV70J19 Integrity Check Monitor (ICM) */
  void* pfnACC_Handler;                          /* 33  SAMV70J19 Analog Comparator Controller (ACC) */
  void* pfnUSBHS_Handler;                        /* 34  SAMV70J19 USB High-Speed Interface (USBHS) */
  ...
  void* pfnMCAN1_INT0_Handler;                   /* 37  SAMV70J19 Controller Area Network (MCAN1) */
  void* pfnMCAN1_INT1_Handler;                   /* 38  SAMV70J19 Controller Area Network (MCAN1) */
  void* pvReserved39;
  void* pfnAFEC1_Handler;                        /* 40  SAMV70J19 Analog Front-End Controller (AFEC1) */
  void* pvReserved41;
  void* pvReserved42;
  void* pfnQSPI_Handler;                         /* 43  SAMV70J19 Quad Serial Peripheral Interface (QSPI) */
  void* pfnUART2_Handler;                        /* 44  SAMV70J19 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pvReserved45;
  void* pvReserved46;
  void* pfnTC6_Handler;                          /* 47  SAMV70J19 Timer Counter (TC2)  */
  void* pfnTC7_Handler;                          /* 48  SAMV70J19 Timer Counter (TC2)  */
  void* pfnTC8_Handler;                          /* 49  SAMV70J19 Timer Counter (TC2)  */
  void* pfnTC9_Handler;                          /* 50  SAMV70J19 Timer Counter (TC3)  */
  void* pfnTC10_Handler;                         /* 51  SAMV70J19 Timer Counter (TC3)  */
  void* pfnTC11_Handler;                         /* 52  SAMV70J19 Timer Counter (TC3)  */
  void* pfnMLB_Handler;                          /* 53  SAMV70J19 Media LB (MLB)       */
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAMV70J19 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAMV70J19 True Random Number Generator (TRNG) */
  void* pfnXDMAC_Handler;                        /* 58  SAMV70J19 Extensible DMA Controller (XDMAC) */
  void* pfnISI_Handler;                          /* 59  SAMV70J19 Image Sensor Interface (ISI) */
  void* pfnPWM1_Handler;                         /* 60  SAMV70J19 Pulse Width Modulation Controller (PWM1) */
  void* pfnFPU_Handler;                          /* 61  SAMV70J19 Floating Point Unit (FPU) */
  void* pvReserved62;
  ...
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMV70J19 Floating Point Unit (FPU) */
} DeviceVectors;
...
/** @}  end of SAMV70J19_cmsis CMSIS Definitions */

/** \defgroup SAMV70J19_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMV70J19_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAMV70J19_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAMV70J19 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMV70J19 */
/* ************************************************************************** */
