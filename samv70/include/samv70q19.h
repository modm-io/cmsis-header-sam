 ...
 * \file
 *
 * \brief Header file for ATSAMV70Q19
 *
...
#ifndef _SAMV70Q19_H_
#define _SAMV70Q19_H_
...
/******  SAMV70Q19 specific Interrupt Numbers ***********************************/
  ...
  EFC_IRQn                  = 6  , /**< 6   SAMV70Q19 Embedded Flash Controller (EFC) */
  UART0_IRQn                = 7  , /**< 7   SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 8  , /**< 8   SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART1) */
  PIOA_IRQn                 = 10 , /**< 10  SAMV70Q19 Parallel Input/Output Controller (PIOA) */
  PIOB_IRQn                 = 11 , /**< 11  SAMV70Q19 Parallel Input/Output Controller (PIOB) */
  PIOC_IRQn                 = 12 , /**< 12  SAMV70Q19 Parallel Input/Output Controller (PIOC) */
  USART0_IRQn               = 13 , /**< 13  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  USART1_IRQn               = 14 , /**< 14  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  USART2_IRQn               = 15 , /**< 15  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  PIOD_IRQn                 = 16 , /**< 16  SAMV70Q19 Parallel Input/Output Controller (PIOD) */
  PIOE_IRQn                 = 17 , /**< 17  SAMV70Q19 Parallel Input/Output Controller (PIOE) */
  HSMCI_IRQn                = 18 , /**< 18  SAMV70Q19 High Speed MultiMedia Card Interface (HSMCI) */
  TWIHS0_IRQn               = 19 , /**< 19  SAMV70Q19 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 20 , /**< 20  SAMV70Q19 Two-wire Interface High Speed (TWIHS1) */
  SPI0_IRQn                 = 21 , /**< 21  SAMV70Q19 Serial Peripheral Interface (SPI0) */
  SSC_IRQn                  = 22 , /**< 22  SAMV70Q19 Synchronous Serial Controller (SSC) */
  TC0_IRQn                  = 23 , /**< 23  SAMV70Q19 Timer Counter (TC0)       */
  TC1_IRQn                  = 24 , /**< 24  SAMV70Q19 Timer Counter (TC0)       */
  TC2_IRQn                  = 25 , /**< 25  SAMV70Q19 Timer Counter (TC0)       */
  TC3_IRQn                  = 26 , /**< 26  SAMV70Q19 Timer Counter (TC1)       */
  TC4_IRQn                  = 27 , /**< 27  SAMV70Q19 Timer Counter (TC1)       */
  TC5_IRQn                  = 28 , /**< 28  SAMV70Q19 Timer Counter (TC1)       */
  AFEC0_IRQn                = 29 , /**< 29  SAMV70Q19 Analog Front-End Controller (AFEC0) */
  DACC_IRQn                 = 30 , /**< 30  SAMV70Q19 Digital-to-Analog Converter Controller (DACC) */
  PWM0_IRQn                 = 31 , /**< 31  SAMV70Q19 Pulse Width Modulation Controller (PWM0) */
  ICM_IRQn                  = 32 , /**< 32  SAMV70Q19 Integrity Check Monitor (ICM) */
  ACC_IRQn                  = 33 , /**< 33  SAMV70Q19 Analog Comparator Controller (ACC) */
  USBHS_IRQn                = 34 , /**< 34  SAMV70Q19 USB High-Speed Interface (USBHS) */
  ...
  AFEC1_IRQn                = 40 , /**< 40  SAMV70Q19 Analog Front-End Controller (AFEC1) */
  TWIHS2_IRQn               = 41 , /**< 41  SAMV70Q19 Two-wire Interface High Speed (TWIHS2) */
  SPI1_IRQn                 = 42 , /**< 42  SAMV70Q19 Serial Peripheral Interface (SPI1) */
  QSPI_IRQn                 = 43 , /**< 43  SAMV70Q19 Quad Serial Peripheral Interface (QSPI) */
  UART2_IRQn                = 44 , /**< 44  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART2) */
  UART3_IRQn                = 45 , /**< 45  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART3) */
  UART4_IRQn                = 46 , /**< 46  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART4) */
  TC6_IRQn                  = 47 , /**< 47  SAMV70Q19 Timer Counter (TC2)       */
  TC7_IRQn                  = 48 , /**< 48  SAMV70Q19 Timer Counter (TC2)       */
  TC8_IRQn                  = 49 , /**< 49  SAMV70Q19 Timer Counter (TC2)       */
  TC9_IRQn                  = 50 , /**< 50  SAMV70Q19 Timer Counter (TC3)       */
  TC10_IRQn                 = 51 , /**< 51  SAMV70Q19 Timer Counter (TC3)       */
  TC11_IRQn                 = 52 , /**< 52  SAMV70Q19 Timer Counter (TC3)       */
  MLB_IRQn                  = 53 , /**< 53  SAMV70Q19 Media LB (MLB)            */
  AES_IRQn                  = 56 , /**< 56  SAMV70Q19 Advanced Encryption Standard (AES) */
  TRNG_IRQn                 = 57 , /**< 57  SAMV70Q19 True Random Number Generator (TRNG) */
  XDMAC_IRQn                = 58 , /**< 58  SAMV70Q19 Extensible DMA Controller (XDMAC) */
  ISI_IRQn                  = 59 , /**< 59  SAMV70Q19 Image Sensor Interface (ISI) */
  PWM1_IRQn                 = 60 , /**< 60  SAMV70Q19 Pulse Width Modulation Controller (PWM1) */
  FPU_IRQn                  = 61 , /**< 61  SAMV70Q19 Floating Point Unit (FPU) */
  SDRAMC_IRQn               = 62 , /**< 62  SAMV70Q19 SDRAM Controller (SDRAMC) */
  RSWDT_IRQn                = 63 , /**< 63  SAMV70Q19 Reinforced Safety Watchdog Timer (RSWDT) */
  IXC_IRQn                  = 68 , /**< 68  SAMV70Q19 Floating Point Unit (FPU) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSUPC_Handler;                         /* 0   SAMV70Q19 Supply Controller (SUPC) */
  void* pfnRSTC_Handler;                         /* 1   SAMV70Q19 Reset Controller (RSTC) */
  void* pfnRTC_Handler;                          /* 2   SAMV70Q19 Real-time Clock (RTC) */
  void* pfnRTT_Handler;                          /* 3   SAMV70Q19 Real-time Timer (RTT) */
  void* pfnWDT_Handler;                          /* 4   SAMV70Q19 Watchdog Timer (WDT) */
  void* pfnPMC_Handler;                          /* 5   SAMV70Q19 Power Management Controller (PMC) */
  void* pfnEFC_Handler;                          /* 6   SAMV70Q19 Embedded Flash Controller (EFC) */
  void* pfnUART0_Handler;                        /* 7   SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 8   SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pvReserved9;
  void* pfnPIOA_Handler;                         /* 10  SAMV70Q19 Parallel Input/Output Controller (PIOA) */
  void* pfnPIOB_Handler;                         /* 11  SAMV70Q19 Parallel Input/Output Controller (PIOB) */
  void* pfnPIOC_Handler;                         /* 12  SAMV70Q19 Parallel Input/Output Controller (PIOC) */
  void* pfnUSART0_Handler;                       /* 13  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART0) */
  void* pfnUSART1_Handler;                       /* 14  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART1) */
  void* pfnUSART2_Handler;                       /* 15  SAMV70Q19 Universal Synchronous Asynchronous Receiver Transmitter (USART2) */
  void* pfnPIOD_Handler;                         /* 16  SAMV70Q19 Parallel Input/Output Controller (PIOD) */
  void* pfnPIOE_Handler;                         /* 17  SAMV70Q19 Parallel Input/Output Controller (PIOE) */
  void* pfnHSMCI_Handler;                        /* 18  SAMV70Q19 High Speed MultiMedia Card Interface (HSMCI) */
  void* pfnTWIHS0_Handler;                       /* 19  SAMV70Q19 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 20  SAMV70Q19 Two-wire Interface High Speed (TWIHS1) */
  void* pfnSPI0_Handler;                         /* 21  SAMV70Q19 Serial Peripheral Interface (SPI0) */
  void* pfnSSC_Handler;                          /* 22  SAMV70Q19 Synchronous Serial Controller (SSC) */
  void* pfnTC0_Handler;                          /* 23  SAMV70Q19 Timer Counter (TC0)  */
  void* pfnTC1_Handler;                          /* 24  SAMV70Q19 Timer Counter (TC0)  */
  void* pfnTC2_Handler;                          /* 25  SAMV70Q19 Timer Counter (TC0)  */
  void* pfnTC3_Handler;                          /* 26  SAMV70Q19 Timer Counter (TC1)  */
  void* pfnTC4_Handler;                          /* 27  SAMV70Q19 Timer Counter (TC1)  */
  void* pfnTC5_Handler;                          /* 28  SAMV70Q19 Timer Counter (TC1)  */
  void* pfnAFEC0_Handler;                        /* 29  SAMV70Q19 Analog Front-End Controller (AFEC0) */
  void* pfnDACC_Handler;                         /* 30  SAMV70Q19 Digital-to-Analog Converter Controller (DACC) */
  void* pfnPWM0_Handler;                         /* 31  SAMV70Q19 Pulse Width Modulation Controller (PWM0) */
  void* pfnICM_Handler;                          /* 32  SAMV70Q19 Integrity Check Monitor (ICM) */
  void* pfnACC_Handler;                          /* 33  SAMV70Q19 Analog Comparator Controller (ACC) */
  void* pfnUSBHS_Handler;                        /* 34  SAMV70Q19 USB High-Speed Interface (USBHS) */
  ...
  void* pvReserved39;
  void* pfnAFEC1_Handler;                        /* 40  SAMV70Q19 Analog Front-End Controller (AFEC1) */
  void* pfnTWIHS2_Handler;                       /* 41  SAMV70Q19 Two-wire Interface High Speed (TWIHS2) */
  void* pfnSPI1_Handler;                         /* 42  SAMV70Q19 Serial Peripheral Interface (SPI1) */
  void* pfnQSPI_Handler;                         /* 43  SAMV70Q19 Quad Serial Peripheral Interface (QSPI) */
  void* pfnUART2_Handler;                        /* 44  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pfnUART3_Handler;                        /* 45  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART3) */
  void* pfnUART4_Handler;                        /* 46  SAMV70Q19 Universal Asynchronous Receiver Transmitter (UART4) */
  void* pfnTC6_Handler;                          /* 47  SAMV70Q19 Timer Counter (TC2)  */
  void* pfnTC7_Handler;                          /* 48  SAMV70Q19 Timer Counter (TC2)  */
  void* pfnTC8_Handler;                          /* 49  SAMV70Q19 Timer Counter (TC2)  */
  void* pfnTC9_Handler;                          /* 50  SAMV70Q19 Timer Counter (TC3)  */
  void* pfnTC10_Handler;                         /* 51  SAMV70Q19 Timer Counter (TC3)  */
  void* pfnTC11_Handler;                         /* 52  SAMV70Q19 Timer Counter (TC3)  */
  void* pfnMLB_Handler;                          /* 53  SAMV70Q19 Media LB (MLB)       */
  void* pvReserved54;
  void* pvReserved55;
  void* pfnAES_Handler;                          /* 56  SAMV70Q19 Advanced Encryption Standard (AES) */
  void* pfnTRNG_Handler;                         /* 57  SAMV70Q19 True Random Number Generator (TRNG) */
  void* pfnXDMAC_Handler;                        /* 58  SAMV70Q19 Extensible DMA Controller (XDMAC) */
  void* pfnISI_Handler;                          /* 59  SAMV70Q19 Image Sensor Interface (ISI) */
  void* pfnPWM1_Handler;                         /* 60  SAMV70Q19 Pulse Width Modulation Controller (PWM1) */
  void* pfnFPU_Handler;                          /* 61  SAMV70Q19 Floating Point Unit (FPU) */
  void* pfnSDRAMC_Handler;                       /* 62  SAMV70Q19 SDRAM Controller (SDRAMC) */
  void* pfnRSWDT_Handler;                        /* 63  SAMV70Q19 Reinforced Safety Watchdog Timer (RSWDT) */
  void* pvReserved64;
  void* pvReserved65;
  void* pvReserved66;
  void* pvReserved67;
  void* pfnIXC_Handler;                          /* 68  SAMV70Q19 Floating Point Unit (FPU) */
} DeviceVectors;
...
/** @}  end of SAMV70Q19_cmsis CMSIS Definitions */

/** \defgroup SAMV70Q19_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMV70Q19_reg Registers Access Definitions
 *  @{
 */
...
/** \addtogroup legacy_SAMV70Q19_id Legacy Peripheral Ids Definitions
 *  @{
 */

/* ************************************************************************** */
/*  LEGACY PERIPHERAL ID DEFINITIONS FOR SAMV70Q19 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/**  DEVICE SIGNATURES FOR SAMV70Q19 */
/* ************************************************************************** */
