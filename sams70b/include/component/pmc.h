...
#ifndef _SAMS70_PMC_COMPONENT_H_
#define _SAMS70_PMC_COMPONENT_H_
#define _SAMS70_PMC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMS_SAMS70 Power Management Controller
 *  @{
 */
/* ========================================================================== */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral Clock 6x Enable               */
...
#define PMC_PCER1_MASK                      _U_(0x1F1FFF07)                                /**< \deprecated (PMC_PCER1) Register MASK  (Use PMC_PCER1_Msk instead)  */
#define PMC_PCER1_Msk                       _U_(0x1F1FFF07)                                /**< (PMC_PCER1) Register Mask  */

#define PMC_PCER1_PID_Pos                   0                                              /**< (PMC_PCER1 Position) Peripheral Clock 6x Enable */
#define PMC_PCER1_PID_Msk                   (_U_(0x1FFFFF) << PMC_PCER1_PID_Pos)           /**< (PMC_PCER1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral Clock 6x Disable              */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_PCDR1_Type;
...
#define PMC_PCDR1_MASK                      _U_(0x1F1FFF07)                                /**< \deprecated (PMC_PCDR1) Register MASK  (Use PMC_PCDR1_Msk instead)  */
#define PMC_PCDR1_Msk                       _U_(0x1F1FFF07)                                /**< (PMC_PCDR1) Register Mask  */

#define PMC_PCDR1_PID_Pos                   0                                              /**< (PMC_PCDR1 Position) Peripheral Clock 6x Disable */
#define PMC_PCDR1_PID_Msk                   (_U_(0x1FFFFF) << PMC_PCDR1_PID_Pos)           /**< (PMC_PCDR1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral Clock 6x Status               */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_PCSR1_Type;
...
#define PMC_PCSR1_MASK                      _U_(0x1F1FFF07)                                /**< \deprecated (PMC_PCSR1) Register MASK  (Use PMC_PCSR1_Msk instead)  */
#define PMC_PCSR1_Msk                       _U_(0x1F1FFF07)                                /**< (PMC_PCSR1) Register Mask  */

#define PMC_PCSR1_PID_Pos                   0                                              /**< (PMC_PCSR1 Position) Peripheral Clock 6x Status */
#define PMC_PCSR1_PID_Msk                   (_U_(0x1FFFFF) << PMC_PCSR1_PID_Pos)           /**< (PMC_PCSR1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral 6x SleepWalking Enable        */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_SLPWK_ER1_Type;
...
#define PMC_SLPWK_ER1_MASK                  _U_(0x1F1FFF07)                                /**< \deprecated (PMC_SLPWK_ER1) Register MASK  (Use PMC_SLPWK_ER1_Msk instead)  */
#define PMC_SLPWK_ER1_Msk                   _U_(0x1F1FFF07)                                /**< (PMC_SLPWK_ER1) Register Mask  */

#define PMC_SLPWK_ER1_PID_Pos               0                                              /**< (PMC_SLPWK_ER1 Position) Peripheral 6x SleepWalking Enable */
#define PMC_SLPWK_ER1_PID_Msk               (_U_(0x1FFFFF) << PMC_SLPWK_ER1_PID_Pos)       /**< (PMC_SLPWK_ER1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral 6x SleepWalking Disable       */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_SLPWK_DR1_Type;
...
#define PMC_SLPWK_DR1_MASK                  _U_(0x1F1FFF07)                                /**< \deprecated (PMC_SLPWK_DR1) Register MASK  (Use PMC_SLPWK_DR1_Msk instead)  */
#define PMC_SLPWK_DR1_Msk                   _U_(0x1F1FFF07)                                /**< (PMC_SLPWK_DR1) Register Mask  */

#define PMC_SLPWK_DR1_PID_Pos               0                                              /**< (PMC_SLPWK_DR1 Position) Peripheral 6x SleepWalking Disable */
#define PMC_SLPWK_DR1_PID_Msk               (_U_(0x1FFFFF) << PMC_SLPWK_DR1_PID_Pos)       /**< (PMC_SLPWK_DR1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral 6x SleepWalking Status        */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_SLPWK_SR1_Type;
...
#define PMC_SLPWK_SR1_MASK                  _U_(0x1F1FFF07)                                /**< \deprecated (PMC_SLPWK_SR1) Register MASK  (Use PMC_SLPWK_SR1_Msk instead)  */
#define PMC_SLPWK_SR1_Msk                   _U_(0x1F1FFF07)                                /**< (PMC_SLPWK_SR1) Register Mask  */

#define PMC_SLPWK_SR1_PID_Pos               0                                              /**< (PMC_SLPWK_SR1 Position) Peripheral 6x SleepWalking Status */
#define PMC_SLPWK_SR1_PID_Msk               (_U_(0x1FFFFF) << PMC_SLPWK_SR1_PID_Pos)       /**< (PMC_SLPWK_SR1 Mask) PID */
...
typedef union {
  ...
  struct {
    uint32_t PID:21;                    /**< bit:  0..20  Peripheral 6x Activity Status            */
    uint32_t :11;                       /**< bit: 21..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} PMC_SLPWK_ASR1_Type;
...
#define PMC_SLPWK_ASR1_MASK                 _U_(0x1F1FFF07)                                /**< \deprecated (PMC_SLPWK_ASR1) Register MASK  (Use PMC_SLPWK_ASR1_Msk instead)  */
#define PMC_SLPWK_ASR1_Msk                  _U_(0x1F1FFF07)                                /**< (PMC_SLPWK_ASR1) Register Mask  */

#define PMC_SLPWK_ASR1_PID_Pos              0                                              /**< (PMC_SLPWK_ASR1 Position) Peripheral 6x Activity Status */
#define PMC_SLPWK_ASR1_PID_Msk              (_U_(0x1FFFFF) << PMC_SLPWK_ASR1_PID_Pos)      /**< (PMC_SLPWK_ASR1 Mask) PID */
...
#endif /* _SAMS70_PMC_COMPONENT_H_ */
