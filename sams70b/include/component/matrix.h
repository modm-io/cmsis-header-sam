...
#define MATRIX_PRBS_MASK                    _U_(0x30003)                                   /**< \deprecated (MATRIX_PRBS) Register MASK  (Use MATRIX_PRBS_Msk instead)  */
#define MATRIX_PRBS_Msk                     _U_(0x30003)                                   /**< (MATRIX_PRBS) Register Mask  */
...
typedef union {
  ...
  struct {
    uint32_t RCB:9;                     /**< bit:   0..8  Remap Command Bit for Master x2          */
...
#define MATRIX_MRCR_MASK                    _U_(0x117F)                                    /**< \deprecated (MATRIX_MRCR) Register MASK  (Use MATRIX_MRCR_Msk instead)  */
#define MATRIX_MRCR_Msk                     _U_(0x117F)                                    /**< (MATRIX_MRCR) Register Mask  */

#define MATRIX_MRCR_RCB_Pos                 0                                              /**< (MATRIX_MRCR Position) Remap Command Bit for Master x2 */
#define MATRIX_MRCR_RCB_Msk                 (_U_(0x1FF) << MATRIX_MRCR_RCB_Pos)            /**< (MATRIX_MRCR Mask) RCB */
